...
import os, time
import re
cmd = "./bin/pose_seg -m0 ./assets/models/YOLOV5Pose640_1.dxnn -p0 0 -m1 assets/3148/HyundaiDDRNet_1.dxnn -i sample/7.jpg"
...
for i in range(10):
    ...
    if "Result saved to result.jpg" in stdout and int(found_bbox.group(1)) == 2:
