/**
 * @file 3ddfa_v2_mobilnet0_5_120x120_factory.hpp
 * @brief 3DDFA v2 MobileNet 0.5 Abstract Factory for face alignment
 *
 * Uses TDDFA postprocessor with simple resize preprocessor.
 */

#ifndef TDDFA_3DDFA_V2_MOBILNET0_5_120X120_FACTORY_HPP
#define TDDFA_3DDFA_V2_MOBILNET0_5_120X120_FACTORY_HPP
...
class Tddfa3ddfa_v2_mobilnet0_5_120x120Factory : public IFaceAlignmentFactory {
public:
    Tddfa3ddfa_v2_mobilnet0_5_120x120Factory() = default;
...
#endif  // TDDFA_3DDFA_V2_MOBILNET0_5_120X120_FACTORY_HPP
