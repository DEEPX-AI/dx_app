...
int main(int argc, char* argv[]) {
    ...
    if (!videoPath.empty()) {
        ...
        std::cout << "[INFO] Video File Info:" << std::endl;
        std::cout << "[INFO] File: " << videoPath << std::endl;
        ...
        std::cout << "[INFO] Total Frames: " << totalFrames << std::endl;
        std::cout << "[INFO] Duration: " << totalFrames / fps << " seconds" << std::endl;
        ...
        while (true) {
            ...
            frameCount++;
            if (frameCount % 100 == 0) {
                std::cout << "[INFO] Processed " << frameCount << " frames" << std::endl;
            }
        ...
        std::cout << "[INFO] Running Without Video Input" << std::endl;
