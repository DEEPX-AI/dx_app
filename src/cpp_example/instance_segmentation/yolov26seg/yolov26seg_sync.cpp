...
/**
 * @brief Synchronous post-processing example for yolov26-seg instance segmentation model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv26-Seg Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv26SegPostProcess& post_processor, ProfilingMetrics& metrics,
    ...
    auto processed_frame = draw_yolov26_segmentation(display_image, detections_vec, pad_xy, ratio);
