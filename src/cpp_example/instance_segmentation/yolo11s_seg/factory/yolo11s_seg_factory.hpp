/**
 * @file yolo11s_seg_factory.hpp
 * @brief Yolo11sSegFactory Abstract Factory implementation
 */

#ifndef YOLO11S_SEG_FACTORY_HPP
#define YOLO11S_SEG_FACTORY_HPP
...
class Yolo11sSegFactory : public IInstanceSegmentationFactory {
public:
    Yolo11sSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11S Seg"; }
