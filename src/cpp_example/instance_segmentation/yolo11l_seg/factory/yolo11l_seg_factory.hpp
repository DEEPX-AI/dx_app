/**
 * @file yolo11l_seg_factory.hpp
 * @brief Yolo11lSegFactory Abstract Factory implementation
 */

#ifndef YOLO11L_SEG_FACTORY_HPP
#define YOLO11L_SEG_FACTORY_HPP
...
class Yolo11lSegFactory : public IInstanceSegmentationFactory {
public:
    Yolo11lSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
