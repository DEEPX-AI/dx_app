/**
 * @file yolov8m_seg_factory.hpp
 * @brief YOLOv8-Seg Abstract Factory implementation
 */

#ifndef YOLOV8M_SEG_FACTORY_HPP
#define YOLOV8M_SEG_FACTORY_HPP
...
class YOLOv8m_segFactory : public IInstanceSegmentationFactory {
public:
    YOLOv8m_segFactory(float score_threshold = 0.3f,
