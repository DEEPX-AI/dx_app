/**
 * @file yolo11x_seg_factory.hpp
 * @brief Yolo11xSegFactory Abstract Factory implementation
 */

#ifndef YOLO11X_SEG_FACTORY_HPP
#define YOLO11X_SEG_FACTORY_HPP
...
class Yolo11xSegFactory : public IInstanceSegmentationFactory {
public:
    Yolo11xSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11X Seg"; }
