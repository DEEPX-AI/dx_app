/**
 * @file yolov8x_seg_factory.hpp
 * @brief Yolov8xSegFactory Abstract Factory implementation
 */

#ifndef YOLOV8X_SEG_FACTORY_HPP
#define YOLOV8X_SEG_FACTORY_HPP
...
class Yolov8xSegFactory : public IInstanceSegmentationFactory {
public:
    Yolov8xSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolov8X Seg"; }
