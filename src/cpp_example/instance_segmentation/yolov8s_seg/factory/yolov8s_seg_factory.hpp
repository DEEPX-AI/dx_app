/**
 * @file yolov8s_seg_factory.hpp
 * @brief YOLOv8-Seg Abstract Factory implementation
 */

#ifndef YOLOV8S_SEG_FACTORY_HPP
#define YOLOV8S_SEG_FACTORY_HPP
...
class YOLOv8s_segFactory : public IInstanceSegmentationFactory {
public:
    YOLOv8s_segFactory(float score_threshold = 0.3f,
