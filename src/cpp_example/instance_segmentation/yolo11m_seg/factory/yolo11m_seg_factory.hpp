/**
 * @file yolo11m_seg_factory.hpp
 * @brief Yolo11mSegFactory Abstract Factory implementation
 */

#ifndef YOLO11M_SEG_FACTORY_HPP
#define YOLO11M_SEG_FACTORY_HPP
...
class Yolo11mSegFactory : public IInstanceSegmentationFactory {
public:
    Yolo11mSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11M Seg"; }
