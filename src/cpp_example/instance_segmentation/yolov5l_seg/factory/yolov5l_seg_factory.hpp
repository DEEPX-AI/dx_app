...
#ifndef YOLOV5L_SEG_FACTORY_HPP
#define YOLOV5L_SEG_FACTORY_HPP
...
class YOLOv5l_segFactory : public IInstanceSegmentationFactory {
public:
    YOLOv5l_segFactory(float obj_threshold = 0.25f,
