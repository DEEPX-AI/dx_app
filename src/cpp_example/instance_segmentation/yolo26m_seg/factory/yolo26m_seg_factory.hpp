/**
 * @file yolo26m_seg_factory.hpp
 * @brief Yolo26m_seg Abstract Factory implementation
 */

#ifndef YOLO26M_SEG_FACTORY_HPP
#define YOLO26M_SEG_FACTORY_HPP
...
class Yolo26m_segFactory : public IInstanceSegmentationFactory {
public:
    Yolo26m_segFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26m_seg"; }
