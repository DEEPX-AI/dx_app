/**
 * @file yolov5x_seg_factory.hpp
 * @brief Yolov5xSegFactory Abstract Factory implementation
 */

#ifndef YOLOV5X_SEG_FACTORY_HPP
#define YOLOV5X_SEG_FACTORY_HPP
...
class Yolov5xSegFactory : public IInstanceSegmentationFactory {
public:
    Yolov5xSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolov5X Seg"; }
