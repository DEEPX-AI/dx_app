/**
 * @file yolov8l_seg_factory.hpp
 * @brief Yolov8lSegFactory Abstract Factory implementation
 */

#ifndef YOLOV8L_SEG_FACTORY_HPP
#define YOLOV8L_SEG_FACTORY_HPP
...
class Yolov8lSegFactory : public IInstanceSegmentationFactory {
public:
    Yolov8lSegFactory(float score_threshold = 0.5f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolov8L Seg"; }
