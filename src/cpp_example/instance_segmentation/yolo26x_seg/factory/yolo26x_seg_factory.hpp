/**
 * @file yolo26x_seg_factory.hpp
 * @brief Yolo26x_seg Abstract Factory implementation
 */

#ifndef YOLO26X_SEG_FACTORY_HPP
#define YOLO26X_SEG_FACTORY_HPP
...
class Yolo26x_segFactory : public IInstanceSegmentationFactory {
public:
    Yolo26x_segFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26x_seg"; }
