/**
 * @file dncnn_50_factory.hpp
 * @brief DnCNN_50 Abstract Factory implementation for image restoration
 * 
 * Part of DX-APP v3.0.0 refactoring.
 * Uses v3-native DnCNN postprocessor with grayscale preprocessor.
 */

#ifndef DNCNN_50_FACTORY_HPP
#define DNCNN_50_FACTORY_HPP
...
class DnCNN_50Factory : public IRestorationFactory {
public:
    DnCNN_50Factory() = default;
    ...
    std::string getModelName() const override { return "DnCNN_50"; }
    std::string getTaskType() const override { return "image_denoising"; }
};

}  // namespace dxapp

#endif  // DNCNN_50_FACTORY_HPP
