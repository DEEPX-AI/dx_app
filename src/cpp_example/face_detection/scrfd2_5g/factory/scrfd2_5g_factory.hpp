/**
 * @file scrfd2_5g_factory.hpp
 * @brief SCRFD2_5g Abstract Factory implementation for face detection
 */

#ifndef SCRFD2_5G_FACTORY_HPP
#define SCRFD2_5G_FACTORY_HPP
...
class SCRFD2_5gFactory : public IFaceDetectionFactory {
public:
    SCRFD2_5gFactory(float score_threshold = 0.5f,
    ...
    std::string getModelName() const override { return "SCRFD2_5g"; }
