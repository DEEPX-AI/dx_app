/**
 * @file scrfd10g_factory.hpp
 * @brief SCRFD10g Abstract Factory implementation for face detection
 */

#ifndef SCRFD10G_FACTORY_HPP
#define SCRFD10G_FACTORY_HPP
...
class SCRFD10gFactory : public IFaceDetectionFactory {
public:
    SCRFD10gFactory(float score_threshold = 0.5f,
    ...
    std::string getModelName() const override { return "SCRFD10g"; }
