/**
 * @file yolov7_w6_tta_face_factory.hpp
 * @brief YOLOv5-Face Abstract Factory implementation for face detection
 */

#ifndef YOLOV7_W6_TTA_FACE_FACTORY_HPP
#define YOLOV7_W6_TTA_FACE_FACTORY_HPP
...
class YOLOv7_w6_tta_faceFactory : public IFaceDetectionFactory {
public:
    YOLOv7_w6_tta_faceFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7-W6-TTA-Face"; }
...
#endif  // YOLOV7_W6_TTA_FACE_FACTORY_HPP
