/**
 * @file yolov5m_face_factory.hpp
 * @brief YOLOv5-Face Abstract Factory implementation for face detection
 */

#ifndef YOLOV5M_FACE_FACTORY_HPP
#define YOLOV5M_FACE_FACTORY_HPP
...
class YOLOv5m_faceFactory : public IFaceDetectionFactory {
public:
    YOLOv5m_faceFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m-Face"; }
...
#endif  // YOLOV5M_FACE_FACTORY_HPP
