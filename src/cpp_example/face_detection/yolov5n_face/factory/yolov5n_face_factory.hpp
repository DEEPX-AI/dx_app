/**
 * @file yolov5n_face_factory.hpp
 * @brief Yolov5nFaceFactory Abstract Factory implementation
 */

#ifndef YOLOV5N_FACE_FACTORY_HPP
#define YOLOV5N_FACE_FACTORY_HPP
...
class Yolov5nFaceFactory : public IFaceDetectionFactory {
public:
    Yolov5nFaceFactory(float score_threshold = 0.5f, float nms_threshold = 0.4f)
    ...
    std::string getModelName() const override { return "Yolov5N Face"; }
...
#endif  // YOLOV5N_FACE_FACTORY_HPP
