/**
 * @file yolov7s_face_factory.hpp
 * @brief YOLOv5-Face Abstract Factory implementation for face detection
 */

#ifndef YOLOV7S_FACE_FACTORY_HPP
#define YOLOV7S_FACE_FACTORY_HPP
...
class YOLOv7s_faceFactory : public IFaceDetectionFactory {
public:
    YOLOv7s_faceFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7s-Face"; }
...
#endif  // YOLOV7S_FACE_FACTORY_HPP
