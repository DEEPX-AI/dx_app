/**
 * @file yolo26_depth_l_factory.hpp
 * @brief Yolo26DepthLFactory Abstract Factory implementation
 *
...
#ifndef YOLO26_DEPTH_L_FACTORY_HPP
#define YOLO26_DEPTH_L_FACTORY_HPP
...
class Yolo26DepthLFactory : public IDepthEstimationFactory {
public:
    Yolo26DepthLFactory() = default;
    ...
    std::string getModelName() const override { return "YOLO26-Depth-L"; }
...
#endif  // YOLO26_DEPTH_L_FACTORY_HPP
