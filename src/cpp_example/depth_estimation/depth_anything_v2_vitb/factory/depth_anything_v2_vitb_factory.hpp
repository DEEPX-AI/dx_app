/**
 * @file depth_anything_v2_vitb_factory.hpp
 * @brief DepthAnythingV2VitbFactory Abstract Factory implementation
 */

#ifndef DEPTH_ANYTHING_V2_VITB_FACTORY_HPP
#define DEPTH_ANYTHING_V2_VITB_FACTORY_HPP
...
class DepthAnythingV2VitbFactory : public IDepthEstimationFactory {
public:
    DepthAnythingV2VitbFactory() = default;
...
#endif  // DEPTH_ANYTHING_V2_VITB_FACTORY_HPP
