/**
 * @file yolo26_depth_n_factory.hpp
 * @brief Yolo26DepthNFactory Abstract Factory implementation
 *
 * YOLO26-Depth-N monocular depth estimation. The compiled model
 * `yolo26-depth-n_768x768.dxnn` takes a uint8 NHWC input
 * `images` [1,768,768,3] and produces a dense float32 depth map
 * `depth` [1,1,768,768].
 */

#ifndef YOLO26_DEPTH_N_FACTORY_HPP
#define YOLO26_DEPTH_N_FACTORY_HPP
...
class Yolo26DepthNFactory : public IDepthEstimationFactory {
public:
    Yolo26DepthNFactory() = default;
    ...
    std::string getModelName() const override { return "YOLO26-Depth-N"; }
...
#endif  // YOLO26_DEPTH_N_FACTORY_HPP
