/**
 * @file yolo26_depth_x_factory.hpp
 * @brief Yolo26DepthXFactory Abstract Factory implementation
 *
 * YOLO26-Depth-X monocular depth estimation. The compiled model
 * `yolo26-depth-x_768x768.dxnn` takes a uint8 NHWC input
 * `images` [1,768,768,3] and produces a dense float32 depth map
 * `depth` [1,1,768,768].
 */

#ifndef YOLO26_DEPTH_X_FACTORY_HPP
#define YOLO26_DEPTH_X_FACTORY_HPP
...
class Yolo26DepthXFactory : public IDepthEstimationFactory {
public:
    Yolo26DepthXFactory() = default;
    ...
    std::string getModelName() const override { return "YOLO26-Depth-X"; }
...
#endif  // YOLO26_DEPTH_X_FACTORY_HPP
