/**
 * @file yolo26m_pose_factory.hpp
 * @brief Yolo26m_pose Abstract Factory implementation
 * 
 * Uses v3-native YOLOv8Pose postprocessor (anchor-free, transposed output).
 */

#ifndef YOLO26M_POSE_FACTORY_HPP
#define YOLO26M_POSE_FACTORY_HPP
...
class Yolo26m_poseFactory : public IPoseFactory {
public:
    Yolo26m_poseFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26m_pose"; }
...
#endif  // YOLO26M_POSE_FACTORY_HPP
