/**
 * @file vit_pose_small_bn_factory.hpp
 * @brief VitPoseSmallBnFactory Abstract Factory implementation
 */

#ifndef VIT_POSE_SMALL_BN_FACTORY_HPP
#define VIT_POSE_SMALL_BN_FACTORY_HPP
...
class VitPoseSmallBnFactory : public IPoseFactory {
public:
    VitPoseSmallBnFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Vit Pose Small Bn"; }
...
#endif  // VIT_POSE_SMALL_BN_FACTORY_HPP
