/**
 * @file yolov8l_pose_factory.hpp
 * @brief Yolov8lPoseFactory Abstract Factory implementation
 */

#ifndef YOLOV8L_POSE_FACTORY_HPP
#define YOLOV8L_POSE_FACTORY_HPP
...
class Yolov8lPoseFactory : public IPoseFactory {
public:
    Yolov8lPoseFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolov8L Pose"; }
...
#endif  // YOLOV8L_POSE_FACTORY_HPP
