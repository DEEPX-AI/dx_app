/**
 * @file yolo26x_pose_factory.hpp
 * @brief Yolo26x_pose Abstract Factory implementation
 * 
 * Uses v3-native YOLOv8Pose postprocessor (anchor-free, transposed output).
 */

#ifndef YOLO26X_POSE_FACTORY_HPP
#define YOLO26X_POSE_FACTORY_HPP
...
class Yolo26x_poseFactory : public IPoseFactory {
public:
    Yolo26x_poseFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26x_pose"; }
...
#endif  // YOLO26X_POSE_FACTORY_HPP
