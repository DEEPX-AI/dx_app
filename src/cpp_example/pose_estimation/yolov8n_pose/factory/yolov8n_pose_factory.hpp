/**
 * @file yolov8n_pose_factory.hpp
 * @brief Yolov8nPoseFactory Abstract Factory implementation
 */

#ifndef YOLOV8N_POSE_FACTORY_HPP
#define YOLOV8N_POSE_FACTORY_HPP
...
class Yolov8nPoseFactory : public IPoseFactory {
public:
    Yolov8nPoseFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolov8N Pose"; }
...
#endif  // YOLOV8N_POSE_FACTORY_HPP
