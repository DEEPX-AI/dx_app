/**
 * @file yolo11x_pose_factory.hpp
 * @brief Yolo11xPoseFactory Abstract Factory implementation
 */

#ifndef YOLO11X_POSE_FACTORY_HPP
#define YOLO11X_POSE_FACTORY_HPP
...
class Yolo11xPoseFactory : public IPoseFactory {
public:
    Yolo11xPoseFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11X Pose"; }
...
#endif  // YOLO11X_POSE_FACTORY_HPP
