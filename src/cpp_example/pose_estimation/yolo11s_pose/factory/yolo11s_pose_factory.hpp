/**
 * @file yolo11s_pose_factory.hpp
 * @brief Yolo11sPoseFactory Abstract Factory implementation
 */

#ifndef YOLO11S_POSE_FACTORY_HPP
#define YOLO11S_POSE_FACTORY_HPP
...
class Yolo11sPoseFactory : public IPoseFactory {
public:
    Yolo11sPoseFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11S Pose"; }
...
#endif  // YOLO11S_POSE_FACTORY_HPP
