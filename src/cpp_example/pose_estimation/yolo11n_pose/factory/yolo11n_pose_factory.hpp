/**
 * @file yolo11n_pose_factory.hpp
 * @brief Yolo11nPoseFactory Abstract Factory implementation
 */

#ifndef YOLO11N_POSE_FACTORY_HPP
#define YOLO11N_POSE_FACTORY_HPP
...
class Yolo11nPoseFactory : public IPoseFactory {
public:
    Yolo11nPoseFactory(float score_threshold = 0.25f, float nms_threshold = 0.65f)
    ...
    std::string getModelName() const override { return "Yolo11N Pose"; }
...
#endif  // YOLO11N_POSE_FACTORY_HPP
