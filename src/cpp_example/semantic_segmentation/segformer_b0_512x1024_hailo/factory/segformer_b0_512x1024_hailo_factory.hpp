/**
 * @file segformer_b0_512x1024_hailo_factory.hpp
 * @brief Segformer_b0_512x1024_hailo Abstract Factory for semantic segmentation
 *
 * SegFormer outputs argmax-style segmentation maps, reuses DeepLabv3Postprocessor.
 */

#ifndef SEGFORMER_B0_512X1024_HAILO_FACTORY_HPP
#define SEGFORMER_B0_512X1024_HAILO_FACTORY_HPP
...
class Segformer_b0_512x1024_hailoFactory : public ISegmentationFactory {
public:
    Segformer_b0_512x1024_hailoFactory() = default;
    ...
    std::string getModelName() const override { return "Segformer_b0_512x1024_hailo"; }
    std::string getTaskType() const override { return "semantic_segmentation"; }
};

}  // namespace dxapp

#endif  // SEGFORMER_B0_512X1024_HAILO_FACTORY_HPP
