/**
 * @file deeplabv3mobilenetv2_factory.hpp
 * @brief DeepLabv3mobilenetv2 Abstract Factory implementation for semantic segmentation
 */

#ifndef DEEPLABV3MOBILENETV2_FACTORY_HPP
#define DEEPLABV3MOBILENETV2_FACTORY_HPP
...
public:
    ...
    std::string getModelName() const override { return "DeepLabv3mobilenetv2"; }
    std::string getTaskType() const override { return "semantic_segmentation"; }
};

}  // namespace dxapp

#endif  // DEEPLABV3MOBILENETV2_FACTORY_HPP
