/**
 * @file deeplabv3_resnet101_factory.hpp
 * @brief Deeplabv3Resnet101Factory Abstract Factory implementation
 */

#ifndef DEEPLABV3_RESNET101_FACTORY_HPP
#define DEEPLABV3_RESNET101_FACTORY_HPP
...
class Deeplabv3Resnet101Factory : public ISegmentationFactory {
public:
    Deeplabv3Resnet101Factory() = default;
    ...
    std::string getModelName() const override { return "Deeplabv3 Resnet101"; }
    std::string getTaskType() const override { return "semantic_segmentation"; }
};

}  // namespace dxapp

#endif  // DEEPLABV3_RESNET101_FACTORY_HPP
