/**
 * @file resnext50_32x4d_hailo_factory.hpp
 * @brief Resnext50_32x4d_hailo Abstract Factory implementation for classification
 */

#ifndef RESNEXT50_32X4D_HAILO_FACTORY_HPP
#define RESNEXT50_32X4D_HAILO_FACTORY_HPP
...
class Resnext50_32x4d_hailoFactory : public IClassificationFactory {
public:
    Resnext50_32x4d_hailoFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resnext50_32x4d_hailo"; }
...
#endif  // RESNEXT50_32X4D_HAILO_FACTORY_HPP
