/**
 * @file deit_small_factory.hpp
 * @brief DeitSmallFactory Abstract Factory implementation
 */

#ifndef DEIT_SMALL_FACTORY_HPP
#define DEIT_SMALL_FACTORY_HPP
...
class DeitSmallFactory : public IClassificationFactory {
public:
    DeitSmallFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Small"; }
