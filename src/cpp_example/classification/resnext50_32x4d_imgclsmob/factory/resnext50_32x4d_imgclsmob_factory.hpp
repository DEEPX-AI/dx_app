/**
 * @file resnext50_32x4d_imgclsmob_factory.hpp
 * @brief Resnext50_32x4d_imgclsmob Abstract Factory implementation for classification
 */

#ifndef RESNEXT50_32X4D_IMGCLSMOB_FACTORY_HPP
#define RESNEXT50_32X4D_IMGCLSMOB_FACTORY_HPP
...
class Resnext50_32x4d_imgclsmobFactory : public IClassificationFactory {
public:
    Resnext50_32x4d_imgclsmobFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resnext50_32x4d_imgclsmob"; }
...
#endif  // RESNEXT50_32X4D_IMGCLSMOB_FACTORY_HPP
