/**
 * @file regnety800mf_factory.hpp
 * @brief Regnety800mf Abstract Factory implementation for classification
 */

#ifndef REGNETY800MF_FACTORY_HPP
#define REGNETY800MF_FACTORY_HPP
...
class Regnety800mfFactory : public IClassificationFactory {
public:
    Regnety800mfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety800mf"; }
...
#endif  // REGNETY800MF_FACTORY_HPP
