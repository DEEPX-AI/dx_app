/**
 * @file densenet121_factory.hpp
 * @brief Densenet121 Abstract Factory implementation for classification
 */

#ifndef DENSENET121_FACTORY_HPP
#define DENSENET121_FACTORY_HPP
...
class Densenet121Factory : public IClassificationFactory {
public:
    Densenet121Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Densenet121"; }
