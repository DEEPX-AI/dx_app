/**
 * @file efficientnetb7_factory.hpp
 * @brief Efficientnetb7Factory Abstract Factory implementation
 */

#ifndef EFFICIENTNETB7_FACTORY_HPP
#define EFFICIENTNETB7_FACTORY_HPP
...
class Efficientnetb7Factory : public IClassificationFactory {
public:
    Efficientnetb7Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Efficientnetb7"; }
...
#endif  // EFFICIENTNETB7_FACTORY_HPP
