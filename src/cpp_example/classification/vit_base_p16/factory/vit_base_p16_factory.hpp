/**
 * @file vit_base_p16_factory.hpp
 * @brief VitBaseP16Factory Abstract Factory implementation
 */

#ifndef VIT_BASE_P16_FACTORY_HPP
#define VIT_BASE_P16_FACTORY_HPP
...
class VitBaseP16Factory : public IClassificationFactory {
public:
    VitBaseP16Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vit Base P16"; }
...
#endif  // VIT_BASE_P16_FACTORY_HPP
