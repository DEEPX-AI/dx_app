/**
 * @file regnetx400mf_factory.hpp
 * @brief Regnetx400mf Abstract Factory implementation for classification
 */

#ifndef REGNETX400MF_FACTORY_HPP
#define REGNETX400MF_FACTORY_HPP
...
class Regnetx400mfFactory : public IClassificationFactory {
public:
    Regnetx400mfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx400mf"; }
...
#endif  // REGNETX400MF_FACTORY_HPP
