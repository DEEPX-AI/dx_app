/**
 * @file shufflenetv2x1_0_factory.hpp
 * @brief Shufflenetv2x1_0 Abstract Factory implementation for classification
 */

#ifndef SHUFFLENETV2X1_0_FACTORY_HPP
#define SHUFFLENETV2X1_0_FACTORY_HPP
...
class Shufflenetv2x1_0Factory : public IClassificationFactory {
public:
    Shufflenetv2x1_0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Shufflenetv2x1_0"; }
...
#endif  // SHUFFLENETV2X1_0_FACTORY_HPP
