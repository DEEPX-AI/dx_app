/**
 * @file wideresnet101_2_factory.hpp
 * @brief WideResNet101_2 Abstract Factory implementation for classification
 */

#ifndef WIDERESNET101_2_FACTORY_HPP
#define WIDERESNET101_2_FACTORY_HPP
...
class WideResNet101_2Factory : public IClassificationFactory {
public:
    WideResNet101_2Factory(int num_classes = 1000, int top_k = 5)
...
#endif  // WIDERESNET101_2_FACTORY_HPP
