/**
 * @file resnext50_32x4d_factory.hpp
 * @brief Resnext50_32x4d Abstract Factory implementation for classification
 */

#ifndef RESNEXT50_32X4D_FACTORY_HPP
#define RESNEXT50_32X4D_FACTORY_HPP
...
class Resnext50_32x4dFactory : public IClassificationFactory {
public:
    Resnext50_32x4dFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resnext50_32x4d"; }
...
#endif  // RESNEXT50_32X4D_FACTORY_HPP
