/**
 * @file deit_small_distilled_factory.hpp
 * @brief DeitSmallDistilledFactory Abstract Factory implementation
 */

#ifndef DEIT_SMALL_DISTILLED_FACTORY_HPP
#define DEIT_SMALL_DISTILLED_FACTORY_HPP
...
class DeitSmallDistilledFactory : public IClassificationFactory {
public:
    DeitSmallDistilledFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Small Distilled"; }
...
#endif  // DEIT_SMALL_DISTILLED_FACTORY_HPP
