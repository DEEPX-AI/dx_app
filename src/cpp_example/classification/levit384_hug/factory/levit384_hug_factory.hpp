/**
 * @file levit384_hug_factory.hpp
 * @brief Levit384_hug Abstract Factory implementation for classification
 */

#ifndef LEVIT384_HUG_FACTORY_HPP
#define LEVIT384_HUG_FACTORY_HPP
...
class Levit384_hugFactory : public IClassificationFactory {
public:
    Levit384_hugFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit384_hug"; }
...
#endif  // LEVIT384_HUG_FACTORY_HPP
