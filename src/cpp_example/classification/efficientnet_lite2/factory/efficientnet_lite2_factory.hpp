/**
 * @file efficientnet_lite2_factory.hpp
 * @brief EfficientNet_lite2 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNET_LITE2_FACTORY_HPP
#define EFFICIENTNET_LITE2_FACTORY_HPP
...
class EfficientNet_lite2Factory : public IClassificationFactory {
public:
    EfficientNet_lite2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNet_lite2"; }
...
#endif  // EFFICIENTNET_LITE2_FACTORY_HPP
