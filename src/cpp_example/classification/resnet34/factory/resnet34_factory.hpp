/**
 * @file resnet34_factory.hpp
 * @brief ResNet34 Abstract Factory implementation for classification
 */

#ifndef RESNET34_FACTORY_HPP
#define RESNET34_FACTORY_HPP
...
class ResNet34Factory : public IClassificationFactory {
public:
    ResNet34Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "ResNet34"; }
