/**
 * @file regnetx1_6gf_v2_factory.hpp
 * @brief Regnetx1_6gf_v2 Abstract Factory implementation for classification
 */

#ifndef REGNETX1_6GF_V2_FACTORY_HPP
#define REGNETX1_6GF_V2_FACTORY_HPP
...
class Regnetx1_6gf_v2Factory : public IClassificationFactory {
public:
    Regnetx1_6gf_v2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx1_6gf_v2"; }
...
#endif  // REGNETX1_6GF_V2_FACTORY_HPP
