/**
 * @file densenet169_factory.hpp
 * @brief Densenet169 Abstract Factory implementation for classification
 */

#ifndef DENSENET169_FACTORY_HPP
#define DENSENET169_FACTORY_HPP
...
class Densenet169Factory : public IClassificationFactory {
public:
    Densenet169Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Densenet169"; }
