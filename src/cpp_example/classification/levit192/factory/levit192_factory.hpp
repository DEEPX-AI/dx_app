/**
 * @file levit192_factory.hpp
 * @brief Levit192 Abstract Factory implementation for classification
 */

#ifndef LEVIT192_FACTORY_HPP
#define LEVIT192_FACTORY_HPP
...
class Levit192Factory : public IClassificationFactory {
public:
    Levit192Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit192"; }
