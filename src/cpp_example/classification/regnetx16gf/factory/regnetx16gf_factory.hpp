/**
 * @file regnetx16gf_factory.hpp
 * @brief Regnetx16gf Abstract Factory implementation for classification
 */

#ifndef REGNETX16GF_FACTORY_HPP
#define REGNETX16GF_FACTORY_HPP
...
class Regnetx16gfFactory : public IClassificationFactory {
public:
    Regnetx16gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx16gf"; }
