/**
 * @file efficientnetb5_factory.hpp
 * @brief EfficientNetb5 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETB5_FACTORY_HPP
#define EFFICIENTNETB5_FACTORY_HPP
...
class EfficientNetb5Factory : public IClassificationFactory {
public:
    EfficientNetb5Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetb5"; }
...
#endif  // EFFICIENTNETB5_FACTORY_HPP
