/**
 * @file regnetx8gf_factory.hpp
 * @brief Regnetx8gf Abstract Factory implementation for classification
 */

#ifndef REGNETX8GF_FACTORY_HPP
#define REGNETX8GF_FACTORY_HPP
...
class Regnetx8gfFactory : public IClassificationFactory {
public:
    Regnetx8gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx8gf"; }
