/**
 * @file resnet50_factory.hpp
 * @brief ResNet50 Abstract Factory implementation for classification
 */

#ifndef RESNET50_FACTORY_HPP
#define RESNET50_FACTORY_HPP
...
class ResNet50Factory : public IClassificationFactory {
public:
    ResNet50Factory(int num_classes = 1000, int top_k = 5)
