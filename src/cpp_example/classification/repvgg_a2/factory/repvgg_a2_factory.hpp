/**
 * @file repvgg_a2_factory.hpp
 * @brief RepvggA2Factory Abstract Factory implementation
 */

#ifndef REPVGG_A2_FACTORY_HPP
#define REPVGG_A2_FACTORY_HPP
...
class RepvggA2Factory : public IClassificationFactory {
public:
    RepvggA2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Repvgg A2"; }
