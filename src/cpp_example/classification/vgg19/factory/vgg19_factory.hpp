/**
 * @file vgg19_factory.hpp
 * @brief Vgg19 Abstract Factory implementation for classification
 */

#ifndef VGG19_FACTORY_HPP
#define VGG19_FACTORY_HPP
...
class Vgg19Factory : public IClassificationFactory {
public:
    Vgg19Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg19"; }
