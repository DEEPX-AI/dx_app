/**
 * @file beit_large_p16_factory.hpp
 * @brief BeitLargeP16Factory Abstract Factory implementation
 */

#ifndef BEIT_LARGE_P16_FACTORY_HPP
#define BEIT_LARGE_P16_FACTORY_HPP
...
class BeitLargeP16Factory : public IClassificationFactory {
public:
    BeitLargeP16Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Beit Large P16"; }
...
#endif  // BEIT_LARGE_P16_FACTORY_HPP
