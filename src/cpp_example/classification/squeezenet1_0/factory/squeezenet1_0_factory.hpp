/**
 * @file squeezenet1_0_factory.hpp
 * @brief Squeezenet1_0 Abstract Factory implementation for classification
 */

#ifndef SQUEEZENET1_0_FACTORY_HPP
#define SQUEEZENET1_0_FACTORY_HPP
...
class Squeezenet1_0Factory : public IClassificationFactory {
public:
    Squeezenet1_0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Squeezenet1_0"; }
...
#endif  // SQUEEZENET1_0_FACTORY_HPP
