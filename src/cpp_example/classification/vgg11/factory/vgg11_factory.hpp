/**
 * @file vgg11_factory.hpp
 * @brief Vgg11 Abstract Factory implementation for classification
 */

#ifndef VGG11_FACTORY_HPP
#define VGG11_FACTORY_HPP
...
class Vgg11Factory : public IClassificationFactory {
public:
    Vgg11Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg11"; }
