/**
 * @file repghost_2_0x_factory.hpp
 * @brief Repghost20xFactory Abstract Factory implementation
 */

#ifndef REPGHOST_2_0X_FACTORY_HPP
#define REPGHOST_2_0X_FACTORY_HPP
...
class Repghost20xFactory : public IClassificationFactory {
public:
    Repghost20xFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Repghost 2 0X"; }
...
#endif  // REPGHOST_2_0X_FACTORY_HPP
