/**
 * @file levit256_hug_factory.hpp
 * @brief Levit256_hug Abstract Factory implementation for classification
 */

#ifndef LEVIT256_HUG_FACTORY_HPP
#define LEVIT256_HUG_FACTORY_HPP
...
class Levit256_hugFactory : public IClassificationFactory {
public:
    Levit256_hugFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit256_hug"; }
...
#endif  // LEVIT256_HUG_FACTORY_HPP
