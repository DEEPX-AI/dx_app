/**
 * @file levit256_factory.hpp
 * @brief Levit256 Abstract Factory implementation for classification
 */

#ifndef LEVIT256_FACTORY_HPP
#define LEVIT256_FACTORY_HPP
...
class Levit256Factory : public IClassificationFactory {
public:
    Levit256Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit256"; }
