/**
 * @file inceptionv1_factory.hpp
 * @brief Inceptionv1 Abstract Factory implementation for classification
 */

#ifndef INCEPTIONV1_FACTORY_HPP
#define INCEPTIONV1_FACTORY_HPP
...
class Inceptionv1Factory : public IClassificationFactory {
public:
    Inceptionv1Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Inceptionv1"; }
