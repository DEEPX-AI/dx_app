/**
 * @file deitbase384_factory.hpp
 * @brief Deitbase384 Abstract Factory implementation for classification
 */

#ifndef DEITBASE384_FACTORY_HPP
#define DEITBASE384_FACTORY_HPP
...
class Deitbase384Factory : public IClassificationFactory {
public:
    Deitbase384Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deitbase384"; }
