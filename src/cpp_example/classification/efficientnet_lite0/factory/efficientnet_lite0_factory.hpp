/**
 * @file efficientnet_lite0_factory.hpp
 * @brief EfficientNet Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNET_LITE0_FACTORY_HPP
#define EFFICIENTNET_LITE0_FACTORY_HPP
...
#endif  // EFFICIENTNET_LITE0_FACTORY_HPP
