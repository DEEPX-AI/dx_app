/**
 * @file efficientnetb6_factory.hpp
 * @brief EfficientNetb6 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETB6_FACTORY_HPP
#define EFFICIENTNETB6_FACTORY_HPP
...
class EfficientNetb6Factory : public IClassificationFactory {
public:
    EfficientNetb6Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetb6"; }
...
#endif  // EFFICIENTNETB6_FACTORY_HPP
