/**
 * @file mobilenetv1_factory.hpp
 * @brief Mobilenetv1 Abstract Factory implementation for classification
 */

#ifndef MOBILENETV1_FACTORY_HPP
#define MOBILENETV1_FACTORY_HPP
...
class Mobilenetv1Factory : public IClassificationFactory {
public:
    Mobilenetv1Factory(int num_classes = 1000, int top_k = 5)
