/**
 * @file fastvit_ma36_factory.hpp
 * @brief FastvitMa36Factory Abstract Factory implementation
 */

#ifndef FASTVIT_MA36_FACTORY_HPP
#define FASTVIT_MA36_FACTORY_HPP
...
class FastvitMa36Factory : public IClassificationFactory {
public:
    FastvitMa36Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Fastvit Ma36"; }
...
#endif  // FASTVIT_MA36_FACTORY_HPP
