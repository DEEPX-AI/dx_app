/**
 * @file regnety1_6gf_factory.hpp
 * @brief Regnety1_6gf Abstract Factory implementation for classification
 */

#ifndef REGNETY1_6GF_FACTORY_HPP
#define REGNETY1_6GF_FACTORY_HPP
...
class Regnety1_6gfFactory : public IClassificationFactory {
public:
    Regnety1_6gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety1_6gf"; }
...
#endif  // REGNETY1_6GF_FACTORY_HPP
