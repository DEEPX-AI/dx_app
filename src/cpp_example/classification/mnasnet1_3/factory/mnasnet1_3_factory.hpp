/**
 * @file mnasnet1_3_factory.hpp
 * @brief Mnasnet1_3 Abstract Factory implementation for classification
 */

#ifndef MNASNET1_3_FACTORY_HPP
#define MNASNET1_3_FACTORY_HPP
...
class Mnasnet1_3Factory : public IClassificationFactory {
public:
    Mnasnet1_3Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mnasnet1_3"; }
