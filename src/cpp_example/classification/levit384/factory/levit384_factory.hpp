/**
 * @file levit384_factory.hpp
 * @brief Levit384 Abstract Factory implementation for classification
 */

#ifndef LEVIT384_FACTORY_HPP
#define LEVIT384_FACTORY_HPP
...
class Levit384Factory : public IClassificationFactory {
public:
    Levit384Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit384"; }
