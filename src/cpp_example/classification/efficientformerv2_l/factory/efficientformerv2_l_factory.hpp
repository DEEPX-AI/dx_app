/**
 * @file efficientformerv2_l_factory.hpp
 * @brief Efficientformerv2_l Abstract Factory implementation for classification
 */

#ifndef EFFICIENTFORMERV2_L_FACTORY_HPP
#define EFFICIENTFORMERV2_L_FACTORY_HPP
...
class Efficientformerv2_lFactory : public IClassificationFactory {
public:
    Efficientformerv2_lFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Efficientformerv2_l"; }
...
#endif  // EFFICIENTFORMERV2_L_FACTORY_HPP
