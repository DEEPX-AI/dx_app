/**
 * @file deit_tiny_factory.hpp
 * @brief DeitTinyFactory Abstract Factory implementation
 */

#ifndef DEIT_TINY_FACTORY_HPP
#define DEIT_TINY_FACTORY_HPP
...
class DeitTinyFactory : public IClassificationFactory {
public:
    DeitTinyFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Tiny"; }
