/**
 * @file resnext26_32x4d_factory.hpp
 * @brief Resnext26_32x4d Abstract Factory implementation for classification
 */

#ifndef RESNEXT26_32X4D_FACTORY_HPP
#define RESNEXT26_32X4D_FACTORY_HPP
...
class Resnext26_32x4dFactory : public IClassificationFactory {
public:
    Resnext26_32x4dFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resnext26_32x4d"; }
...
#endif  // RESNEXT26_32X4D_FACTORY_HPP
