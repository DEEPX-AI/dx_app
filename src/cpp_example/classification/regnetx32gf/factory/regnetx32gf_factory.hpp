/**
 * @file regnetx32gf_factory.hpp
 * @brief Regnetx32gf Abstract Factory implementation for classification
 */

#ifndef REGNETX32GF_FACTORY_HPP
#define REGNETX32GF_FACTORY_HPP
...
class Regnetx32gfFactory : public IClassificationFactory {
public:
    Regnetx32gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx32gf"; }
