/**
 * @file squeezenet1_1_factory.hpp
 * @brief Squeezenet1_1 Abstract Factory implementation for classification
 */

#ifndef SQUEEZENET1_1_FACTORY_HPP
#define SQUEEZENET1_1_FACTORY_HPP
...
class Squeezenet1_1Factory : public IClassificationFactory {
public:
    Squeezenet1_1Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Squeezenet1_1"; }
...
#endif  // SQUEEZENET1_1_FACTORY_HPP
