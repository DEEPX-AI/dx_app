/**
 * @file regnety32gf_factory.hpp
 * @brief Regnety32gf Abstract Factory implementation for classification
 */

#ifndef REGNETY32GF_FACTORY_HPP
#define REGNETY32GF_FACTORY_HPP
...
class Regnety32gfFactory : public IClassificationFactory {
public:
    Regnety32gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety32gf"; }
