/**
 * @file osnet0_5_factory.hpp
 * @brief OSNet-0.5 Abstract Factory implementation for classification
 */

#ifndef OSNET0_5_FACTORY_HPP
#define OSNET0_5_FACTORY_HPP
...
class Osnet05Factory : public IClassificationFactory {
public:
    Osnet05Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "OSNet-0.5"; }
