/**
 * @file regnetx3_2gf_factory.hpp
 * @brief Regnetx3_2gf Abstract Factory implementation for classification
 */

#ifndef REGNETX3_2GF_FACTORY_HPP
#define REGNETX3_2GF_FACTORY_HPP
...
class Regnetx3_2gfFactory : public IClassificationFactory {
public:
    Regnetx3_2gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx3_2gf"; }
...
#endif  // REGNETX3_2GF_FACTORY_HPP
