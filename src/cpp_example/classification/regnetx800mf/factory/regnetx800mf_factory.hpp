/**
 * @file regnetx800mf_factory.hpp
 * @brief Regnetx800mf Abstract Factory implementation for classification
 */

#ifndef REGNETX800MF_FACTORY_HPP
#define REGNETX800MF_FACTORY_HPP
...
class Regnetx800mfFactory : public IClassificationFactory {
public:
    Regnetx800mfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx800mf"; }
...
#endif  // REGNETX800MF_FACTORY_HPP
