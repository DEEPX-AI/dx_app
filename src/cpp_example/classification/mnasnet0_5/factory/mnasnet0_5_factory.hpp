/**
 * @file mnasnet0_5_factory.hpp
 * @brief Mnasnet0_5 Abstract Factory implementation for classification
 */

#ifndef MNASNET0_5_FACTORY_HPP
#define MNASNET0_5_FACTORY_HPP
...
class Mnasnet0_5Factory : public IClassificationFactory {
public:
    Mnasnet0_5Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mnasnet0_5"; }
