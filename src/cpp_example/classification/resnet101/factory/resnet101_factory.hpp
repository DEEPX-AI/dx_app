/**
 * @file resnet101_factory.hpp
 * @brief ResNet101 Abstract Factory implementation for classification
 */

#ifndef RESNET101_FACTORY_HPP
#define RESNET101_FACTORY_HPP
...
class ResNet101Factory : public IClassificationFactory {
public:
    ResNet101Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "ResNet101"; }
