/**
 * @file regnety16gf_factory.hpp
 * @brief Regnety16gf Abstract Factory implementation for classification
 */

#ifndef REGNETY16GF_FACTORY_HPP
#define REGNETY16GF_FACTORY_HPP
...
class Regnety16gfFactory : public IClassificationFactory {
public:
    Regnety16gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety16gf"; }
