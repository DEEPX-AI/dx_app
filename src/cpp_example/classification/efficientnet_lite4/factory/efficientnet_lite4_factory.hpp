/**
 * @file efficientnet_lite4_factory.hpp
 * @brief EfficientNet_lite4 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNET_LITE4_FACTORY_HPP
#define EFFICIENTNET_LITE4_FACTORY_HPP
...
class EfficientNet_lite4Factory : public IClassificationFactory {
public:
    EfficientNet_lite4Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNet_lite4"; }
...
#endif  // EFFICIENTNET_LITE4_FACTORY_HPP
