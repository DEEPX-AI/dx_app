/**
 * @file shufflenetv1x1_0_factory.hpp
 * @brief Shufflenetv1x1_0 Abstract Factory implementation for classification
 */

#ifndef SHUFFLENETV1X1_0_FACTORY_HPP
#define SHUFFLENETV1X1_0_FACTORY_HPP
...
class Shufflenetv1x1_0Factory : public IClassificationFactory {
public:
    Shufflenetv1x1_0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Shufflenetv1x1_0"; }
...
#endif  // SHUFFLENETV1X1_0_FACTORY_HPP
