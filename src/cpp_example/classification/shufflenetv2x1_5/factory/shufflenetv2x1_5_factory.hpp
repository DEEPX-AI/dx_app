/**
 * @file shufflenetv2x1_5_factory.hpp
 * @brief Shufflenetv2x1_5 Abstract Factory implementation for classification
 */

#ifndef SHUFFLENETV2X1_5_FACTORY_HPP
#define SHUFFLENETV2X1_5_FACTORY_HPP
...
class Shufflenetv2x1_5Factory : public IClassificationFactory {
public:
    Shufflenetv2x1_5Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Shufflenetv2x1_5"; }
...
#endif  // SHUFFLENETV2X1_5_FACTORY_HPP
