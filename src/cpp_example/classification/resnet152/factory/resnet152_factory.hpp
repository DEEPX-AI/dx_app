/**
 * @file resnet152_factory.hpp
 * @brief ResNet152 Abstract Factory implementation for classification
 */

#ifndef RESNET152_FACTORY_HPP
#define RESNET152_FACTORY_HPP
...
class ResNet152Factory : public IClassificationFactory {
public:
    ResNet152Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "ResNet152"; }
