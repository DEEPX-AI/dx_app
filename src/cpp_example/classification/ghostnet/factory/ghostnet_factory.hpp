/**
 * @file ghostnet_factory.hpp
 * @brief GhostnetFactory Abstract Factory implementation
 */

#ifndef GHOSTNET_FACTORY_HPP
#define GHOSTNET_FACTORY_HPP
...
class GhostnetFactory : public IClassificationFactory {
public:
    GhostnetFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Ghostnet"; }
