/**
 * @file resnext101_32x8d_factory.hpp
 * @brief Resnext10132x8dFactory Abstract Factory implementation
 */

#ifndef RESNEXT101_32X8D_FACTORY_HPP
#define RESNEXT101_32X8D_FACTORY_HPP
...
class Resnext10132x8dFactory : public IClassificationFactory {
public:
    Resnext10132x8dFactory(int num_classes = 1000, int top_k = 5)
...
#endif  // RESNEXT101_32X8D_FACTORY_HPP
