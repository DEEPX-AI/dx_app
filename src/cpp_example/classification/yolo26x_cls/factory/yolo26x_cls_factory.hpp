/**
 * @file yolo26x_cls_factory.hpp
 * @brief Yolo26x_cls Abstract Factory implementation for classification
 */

#ifndef YOLO26X_CLS_FACTORY_HPP
#define YOLO26X_CLS_FACTORY_HPP
...
class Yolo26x_clsFactory : public IClassificationFactory {
public:
    Yolo26x_clsFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Yolo26x_cls"; }
