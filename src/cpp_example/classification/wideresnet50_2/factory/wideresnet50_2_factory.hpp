/**
 * @file wideresnet50_2_factory.hpp
 * @brief WideResNet50_2 Abstract Factory implementation for classification
 */

#ifndef WIDERESNET50_2_FACTORY_HPP
#define WIDERESNET50_2_FACTORY_HPP
...
class WideResNet50_2Factory : public IClassificationFactory {
public:
    WideResNet50_2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "WideResNet50_2"; }
...
#endif  // WIDERESNET50_2_FACTORY_HPP
