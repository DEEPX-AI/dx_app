/**
 * @file vgg16bn_factory.hpp
 * @brief Vgg16bn Abstract Factory implementation for classification
 */

#ifndef VGG16BN_FACTORY_HPP
#define VGG16BN_FACTORY_HPP
...
class Vgg16bnFactory : public IClassificationFactory {
public:
    Vgg16bnFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg16bn"; }
