/**
 * @file vgg13bn_factory.hpp
 * @brief Vgg13bn Abstract Factory implementation for classification
 */

#ifndef VGG13BN_FACTORY_HPP
#define VGG13BN_FACTORY_HPP
...
class Vgg13bnFactory : public IClassificationFactory {
public:
    Vgg13bnFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg13bn"; }
