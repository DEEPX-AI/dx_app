/**
 * @file efficientnet_lite3_factory.hpp
 * @brief EfficientNet_lite3 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNET_LITE3_FACTORY_HPP
#define EFFICIENTNET_LITE3_FACTORY_HPP
...
class EfficientNet_lite3Factory : public IClassificationFactory {
public:
    EfficientNet_lite3Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNet_lite3"; }
...
#endif  // EFFICIENTNET_LITE3_FACTORY_HPP
