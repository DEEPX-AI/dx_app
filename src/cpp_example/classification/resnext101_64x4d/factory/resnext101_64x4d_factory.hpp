/**
 * @file resnext101_64x4d_factory.hpp
 * @brief Resnext101_64x4d Abstract Factory implementation for classification
 */

#ifndef RESNEXT101_64X4D_FACTORY_HPP
#define RESNEXT101_64X4D_FACTORY_HPP
...
class Resnext101_64x4dFactory : public IClassificationFactory {
public:
    Resnext101_64x4dFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resnext101_64x4d"; }
...
#endif  // RESNEXT101_64X4D_FACTORY_HPP
