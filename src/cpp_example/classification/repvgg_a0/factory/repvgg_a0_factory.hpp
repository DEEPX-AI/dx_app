/**
 * @file repvgg_a0_factory.hpp
 * @brief RepvggA0Factory Abstract Factory implementation
 */

#ifndef REPVGG_A0_FACTORY_HPP
#define REPVGG_A0_FACTORY_HPP
...
class RepvggA0Factory : public IClassificationFactory {
public:
    RepvggA0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Repvgg A0"; }
