/**
 * @file densenet201_factory.hpp
 * @brief Densenet201 Abstract Factory implementation for classification
 */

#ifndef DENSENET201_FACTORY_HPP
#define DENSENET201_FACTORY_HPP
...
class Densenet201Factory : public IClassificationFactory {
public:
    Densenet201Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Densenet201"; }
