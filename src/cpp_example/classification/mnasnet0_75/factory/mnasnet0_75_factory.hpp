/**
 * @file mnasnet0_75_factory.hpp
 * @brief Mnasnet0_75 Abstract Factory implementation for classification
 */

#ifndef MNASNET0_75_FACTORY_HPP
#define MNASNET0_75_FACTORY_HPP
...
class Mnasnet0_75Factory : public IClassificationFactory {
public:
    Mnasnet0_75Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mnasnet0_75"; }
