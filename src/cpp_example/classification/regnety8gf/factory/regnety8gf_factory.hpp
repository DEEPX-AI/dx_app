/**
 * @file regnety8gf_factory.hpp
 * @brief Regnety8gf Abstract Factory implementation for classification
 */

#ifndef REGNETY8GF_FACTORY_HPP
#define REGNETY8GF_FACTORY_HPP
...
class Regnety8gfFactory : public IClassificationFactory {
public:
    Regnety8gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety8gf"; }
