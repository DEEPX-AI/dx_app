/**
 * @file shufflenetv2x2_0_factory.hpp
 * @brief Shufflenetv2x2_0 Abstract Factory implementation for classification
 */

#ifndef SHUFFLENETV2X2_0_FACTORY_HPP
#define SHUFFLENETV2X2_0_FACTORY_HPP
...
class Shufflenetv2x2_0Factory : public IClassificationFactory {
public:
    Shufflenetv2x2_0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Shufflenetv2x2_0"; }
...
#endif  // SHUFFLENETV2X2_0_FACTORY_HPP
