/**
 * @file vgg11bn_factory.hpp
 * @brief Vgg11bn Abstract Factory implementation for classification
 */

#ifndef VGG11BN_FACTORY_HPP
#define VGG11BN_FACTORY_HPP
...
class Vgg11bnFactory : public IClassificationFactory {
public:
    Vgg11bnFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg11bn"; }
