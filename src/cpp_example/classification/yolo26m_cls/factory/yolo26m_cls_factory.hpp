/**
 * @file yolo26m_cls_factory.hpp
 * @brief Yolo26m_cls Abstract Factory implementation for classification
 */

#ifndef YOLO26M_CLS_FACTORY_HPP
#define YOLO26M_CLS_FACTORY_HPP
...
class Yolo26m_clsFactory : public IClassificationFactory {
public:
    Yolo26m_clsFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Yolo26m_cls"; }
