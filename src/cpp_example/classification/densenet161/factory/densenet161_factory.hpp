/**
 * @file densenet161_factory.hpp
 * @brief Densenet161 Abstract Factory implementation for classification
 */

#ifndef DENSENET161_FACTORY_HPP
#define DENSENET161_FACTORY_HPP
...
class Densenet161Factory : public IClassificationFactory {
public:
    Densenet161Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Densenet161"; }
