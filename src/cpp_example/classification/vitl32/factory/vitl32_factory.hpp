/**
 * @file vitl32_factory.hpp
 * @brief Vitl32 Abstract Factory implementation for classification
 */

#ifndef VITL32_FACTORY_HPP
#define VITL32_FACTORY_HPP
...
class Vitl32Factory : public IClassificationFactory {
public:
    Vitl32Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vitl32"; }
