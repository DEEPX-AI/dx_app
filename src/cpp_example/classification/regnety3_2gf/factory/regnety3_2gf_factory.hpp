/**
 * @file regnety3_2gf_factory.hpp
 * @brief Regnety3_2gf Abstract Factory implementation for classification
 */

#ifndef REGNETY3_2GF_FACTORY_HPP
#define REGNETY3_2GF_FACTORY_HPP
...
class Regnety3_2gfFactory : public IClassificationFactory {
public:
    Regnety3_2gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety3_2gf"; }
...
#endif  // REGNETY3_2GF_FACTORY_HPP
