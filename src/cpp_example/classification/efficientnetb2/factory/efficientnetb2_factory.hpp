/**
 * @file efficientnetb2_factory.hpp
 * @brief EfficientNetb2 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETB2_FACTORY_HPP
#define EFFICIENTNETB2_FACTORY_HPP
...
class EfficientNetb2Factory : public IClassificationFactory {
public:
    EfficientNetb2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetb2"; }
...
#endif  // EFFICIENTNETB2_FACTORY_HPP
