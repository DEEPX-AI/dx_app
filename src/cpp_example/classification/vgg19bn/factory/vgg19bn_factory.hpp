/**
 * @file vgg19bn_factory.hpp
 * @brief Vgg19bn Abstract Factory implementation for classification
 */

#ifndef VGG19BN_FACTORY_HPP
#define VGG19BN_FACTORY_HPP
...
class Vgg19bnFactory : public IClassificationFactory {
public:
    Vgg19bnFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg19bn"; }
