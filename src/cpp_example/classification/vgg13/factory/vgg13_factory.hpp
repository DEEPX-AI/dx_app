/**
 * @file vgg13_factory.hpp
 * @brief Vgg13 Abstract Factory implementation for classification
 */

#ifndef VGG13_FACTORY_HPP
#define VGG13_FACTORY_HPP
...
class Vgg13Factory : public IClassificationFactory {
public:
    Vgg13Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vgg13"; }
