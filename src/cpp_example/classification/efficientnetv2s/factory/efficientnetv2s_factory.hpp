/**
 * @file efficientnetv2s_factory.hpp
 * @brief EfficientNetv2s Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETV2S_FACTORY_HPP
#define EFFICIENTNETV2S_FACTORY_HPP
...
class EfficientNetv2sFactory : public IClassificationFactory {
public:
    EfficientNetv2sFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetv2s"; }
...
#endif  // EFFICIENTNETV2S_FACTORY_HPP
