/**
 * @file efficientformer_l3_factory.hpp
 * @brief Efficientformer_l3 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTFORMER_L3_FACTORY_HPP
#define EFFICIENTFORMER_L3_FACTORY_HPP
...
class Efficientformer_l3Factory : public IClassificationFactory {
public:
    Efficientformer_l3Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Efficientformer_l3"; }
...
#endif  // EFFICIENTFORMER_L3_FACTORY_HPP
