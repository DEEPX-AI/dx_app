/**
 * @file deit_tiny_distilled_factory.hpp
 * @brief DeitTinyDistilledFactory Abstract Factory implementation
 */

#ifndef DEIT_TINY_DISTILLED_FACTORY_HPP
#define DEIT_TINY_DISTILLED_FACTORY_HPP
...
class DeitTinyDistilledFactory : public IClassificationFactory {
public:
    DeitTinyDistilledFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Tiny Distilled"; }
...
#endif  // DEIT_TINY_DISTILLED_FACTORY_HPP
