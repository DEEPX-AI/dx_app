/**
 * @file vgg16_factory.hpp
 * @brief Vgg16 Abstract Factory implementation for classification
 */

#ifndef VGG16_FACTORY_HPP
#define VGG16_FACTORY_HPP
...
class Vgg16Factory : public IClassificationFactory {
public:
    Vgg16Factory(int num_classes = 1000, int top_k = 5)
