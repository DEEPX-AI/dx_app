/**
 * @file efficientnetv2l_factory.hpp
 * @brief EfficientNetv2l Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETV2L_FACTORY_HPP
#define EFFICIENTNETV2L_FACTORY_HPP
...
class EfficientNetv2lFactory : public IClassificationFactory {
public:
    EfficientNetv2lFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetv2l"; }
...
#endif  // EFFICIENTNETV2L_FACTORY_HPP
