/**
 * @file repvgg_b0_factory.hpp
 * @brief RepvggB0Factory Abstract Factory implementation
 */

#ifndef REPVGG_B0_FACTORY_HPP
#define REPVGG_B0_FACTORY_HPP
...
class RepvggB0Factory : public IClassificationFactory {
public:
    RepvggB0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Repvgg B0"; }
