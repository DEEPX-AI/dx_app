/**
 * @file regnetx1_6gf_factory.hpp
 * @brief Regnetx1_6gf Abstract Factory implementation for classification
 */

#ifndef REGNETX1_6GF_FACTORY_HPP
#define REGNETX1_6GF_FACTORY_HPP
...
class Regnetx1_6gfFactory : public IClassificationFactory {
public:
    Regnetx1_6gfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx1_6gf"; }
...
#endif  // REGNETX1_6GF_FACTORY_HPP
