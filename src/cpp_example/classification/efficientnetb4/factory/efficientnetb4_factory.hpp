/**
 * @file efficientnetb4_factory.hpp
 * @brief EfficientNetb4 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTNETB4_FACTORY_HPP
#define EFFICIENTNETB4_FACTORY_HPP
...
class EfficientNetb4Factory : public IClassificationFactory {
public:
    EfficientNetb4Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "EfficientNetb4"; }
...
#endif  // EFFICIENTNETB4_FACTORY_HPP
