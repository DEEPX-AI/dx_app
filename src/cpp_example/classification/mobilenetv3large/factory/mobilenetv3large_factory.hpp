/**
 * @file mobilenetv3large_factory.hpp
 * @brief Mobilenetv3large Abstract Factory implementation for classification
 */

#ifndef MOBILENETV3LARGE_FACTORY_HPP
#define MOBILENETV3LARGE_FACTORY_HPP
...
class Mobilenetv3largeFactory : public IClassificationFactory {
public:
    Mobilenetv3largeFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mobilenetv3large"; }
...
#endif  // MOBILENETV3LARGE_FACTORY_HPP
