/**
 * @file deit_base_distilled_factory.hpp
 * @brief DeitBaseDistilled1Factory Abstract Factory implementation
 */

#ifndef DEIT_BASE_DISTILLED_1_FACTORY_HPP
#define DEIT_BASE_DISTILLED_1_FACTORY_HPP
...
class DeitBaseDistilled1Factory : public IClassificationFactory {
public:
    DeitBaseDistilled1Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Base Distilled 1"; }
...
#endif  // DEIT_BASE_DISTILLED_1_FACTORY_HPP
