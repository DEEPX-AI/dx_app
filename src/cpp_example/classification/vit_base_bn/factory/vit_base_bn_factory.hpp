/**
 * @file vit_base_bn_factory.hpp
 * @brief VitBaseBnFactory Abstract Factory implementation
 */

#ifndef VIT_BASE_BN_FACTORY_HPP
#define VIT_BASE_BN_FACTORY_HPP
...
class VitBaseBnFactory : public IClassificationFactory {
public:
    VitBaseBnFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vit Base Bn"; }
