/**
 * @file fastvit_sa24_factory.hpp
 * @brief FastvitSa24Factory Abstract Factory implementation
 */

#ifndef FASTVIT_SA24_FACTORY_HPP
#define FASTVIT_SA24_FACTORY_HPP
...
class FastvitSa24Factory : public IClassificationFactory {
public:
    FastvitSa24Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Fastvit Sa24"; }
...
#endif  // FASTVIT_SA24_FACTORY_HPP
