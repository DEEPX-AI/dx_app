/**
 * @file hardnet68_factory.hpp
 * @brief Hardnet68 Abstract Factory implementation for classification
 */

#ifndef HARDNET68_FACTORY_HPP
#define HARDNET68_FACTORY_HPP
...
class Hardnet68Factory : public IClassificationFactory {
public:
    Hardnet68Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Hardnet68"; }
