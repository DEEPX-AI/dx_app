/**
 * @file levit128_hug_factory.hpp
 * @brief Levit128_hug Abstract Factory implementation for classification
 */

#ifndef LEVIT128_HUG_FACTORY_HPP
#define LEVIT128_HUG_FACTORY_HPP
...
class Levit128_hugFactory : public IClassificationFactory {
public:
    Levit128_hugFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit128_hug"; }
...
#endif  // LEVIT128_HUG_FACTORY_HPP
