/**
 * @file vit_small_p16_factory.hpp
 * @brief VitSmallP16Factory Abstract Factory implementation
 */

#ifndef VIT_SMALL_P16_FACTORY_HPP
#define VIT_SMALL_P16_FACTORY_HPP
...
class VitSmallP16Factory : public IClassificationFactory {
public:
    VitSmallP16Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vit Small P16"; }
...
#endif  // VIT_SMALL_P16_FACTORY_HPP
