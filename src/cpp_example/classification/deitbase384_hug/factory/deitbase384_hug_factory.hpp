/**
 * @file deitbase384_hug_factory.hpp
 * @brief Deitbase384_hug Abstract Factory implementation for classification
 */

#ifndef DEITBASE384_HUG_FACTORY_HPP
#define DEITBASE384_HUG_FACTORY_HPP
...
class Deitbase384_hugFactory : public IClassificationFactory {
public:
    Deitbase384_hugFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deitbase384_hug"; }
...
#endif  // DEITBASE384_HUG_FACTORY_HPP
