/**
 * @file deit_base384_distilled_factory.hpp
 * @brief DeitBase384DistilledFactory Abstract Factory implementation
 */

#ifndef DEIT_BASE384_DISTILLED_FACTORY_HPP
#define DEIT_BASE384_DISTILLED_FACTORY_HPP
...
class DeitBase384DistilledFactory : public IClassificationFactory {
public:
    DeitBase384DistilledFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Base384 Distilled"; }
...
#endif  // DEIT_BASE384_DISTILLED_FACTORY_HPP
