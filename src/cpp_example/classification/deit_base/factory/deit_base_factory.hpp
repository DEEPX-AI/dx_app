/**
 * @file deit_base_factory.hpp
 * @brief DeitBaseFactory Abstract Factory implementation
 */

#ifndef DEIT_BASE_FACTORY_HPP
#define DEIT_BASE_FACTORY_HPP
...
class DeitBaseFactory : public IClassificationFactory {
public:
    DeitBaseFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Deit Base"; }
