/**
 * @file vitb32_factory.hpp
 * @brief Vitb32 Abstract Factory implementation for classification
 */

#ifndef VITB32_FACTORY_HPP
#define VITB32_FACTORY_HPP
...
class Vitb32Factory : public IClassificationFactory {
public:
    Vitb32Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Vitb32"; }
