/**
 * @file repvgg_b1_factory.hpp
 * @brief RepvggB1Factory Abstract Factory implementation
 */

#ifndef REPVGG_B1_FACTORY_HPP
#define REPVGG_B1_FACTORY_HPP
...
class RepvggB1Factory : public IClassificationFactory {
public:
    RepvggB1Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Repvgg B1"; }
