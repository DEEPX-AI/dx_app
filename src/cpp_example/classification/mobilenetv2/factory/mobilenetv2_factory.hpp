/**
 * @file mobilenetv2_factory.hpp
 * @brief Mobilenetv2 Abstract Factory implementation for classification
 */

#ifndef MOBILENETV2_FACTORY_HPP
#define MOBILENETV2_FACTORY_HPP
...
class Mobilenetv2Factory : public IClassificationFactory {
public:
    Mobilenetv2Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mobilenetv2"; }
