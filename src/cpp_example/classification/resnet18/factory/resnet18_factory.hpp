/**
 * @file resnet18_factory.hpp
 * @brief ResNet18 Abstract Factory implementation for classification
 */

#ifndef RESNET18_FACTORY_HPP
#define RESNET18_FACTORY_HPP
...
class ResNet18Factory : public IClassificationFactory {
public:
    ResNet18Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "ResNet18"; }
