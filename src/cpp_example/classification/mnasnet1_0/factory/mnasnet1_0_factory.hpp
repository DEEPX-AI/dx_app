/**
 * @file mnasnet1_0_factory.hpp
 * @brief Mnasnet1_0 Abstract Factory implementation for classification
 */

#ifndef MNASNET1_0_FACTORY_HPP
#define MNASNET1_0_FACTORY_HPP
...
class Mnasnet1_0Factory : public IClassificationFactory {
public:
    Mnasnet1_0Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Mnasnet1_0"; }
