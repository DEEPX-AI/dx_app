/**
 * @file resmlp24_factory.hpp
 * @brief Resmlp24Factory Abstract Factory implementation
 */

#ifndef RESMLP24_FACTORY_HPP
#define RESMLP24_FACTORY_HPP
...
class Resmlp24Factory : public IClassificationFactory {
public:
    Resmlp24Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Resmlp24"; }
