/**
 * @file regnetx1_6gf_h_factory.hpp
 * @brief Regnetx1_6gf_h Abstract Factory implementation for classification
 */

#ifndef REGNETX1_6GF_h_FACTORY_HPP
#define REGNETX1_6GF_h_FACTORY_HPP
...
class Regnetx1_6gf_hFactory : public IClassificationFactory {
public:
    Regnetx1_6gf_hFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnetx1_6gf_h"; }
...
#endif  // REGNETX1_6GF_h_FACTORY_HPP
