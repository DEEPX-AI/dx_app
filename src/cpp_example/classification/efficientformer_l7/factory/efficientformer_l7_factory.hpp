/**
 * @file efficientformer_l7_factory.hpp
 * @brief Efficientformer_l7 Abstract Factory implementation for classification
 */

#ifndef EFFICIENTFORMER_L7_FACTORY_HPP
#define EFFICIENTFORMER_L7_FACTORY_HPP
...
class Efficientformer_l7Factory : public IClassificationFactory {
public:
    Efficientformer_l7Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Efficientformer_l7"; }
...
#endif  // EFFICIENTFORMER_L7_FACTORY_HPP
