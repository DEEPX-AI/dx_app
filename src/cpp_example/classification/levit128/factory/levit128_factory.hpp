/**
 * @file levit128_factory.hpp
 * @brief Levit128 Abstract Factory implementation for classification
 */

#ifndef LEVIT128_FACTORY_HPP
#define LEVIT128_FACTORY_HPP
...
class Levit128Factory : public IClassificationFactory {
public:
    Levit128Factory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Levit128"; }
