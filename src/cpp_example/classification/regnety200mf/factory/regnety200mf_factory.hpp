/**
 * @file regnety200mf_factory.hpp
 * @brief Regnety200mf Abstract Factory implementation for classification
 */

#ifndef REGNETY200MF_FACTORY_HPP
#define REGNETY200MF_FACTORY_HPP
...
class Regnety200mfFactory : public IClassificationFactory {
public:
    Regnety200mfFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Regnety200mf"; }
...
#endif  // REGNETY200MF_FACTORY_HPP
