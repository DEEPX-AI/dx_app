/**
 * @file alexnet_factory.hpp
 * @brief Alexnet Abstract Factory implementation for classification
 */

#ifndef ALEXNET_FACTORY_HPP
#define ALEXNET_FACTORY_HPP
...
class AlexnetFactory : public IClassificationFactory {
public:
    AlexnetFactory(int num_classes = 1000, int top_k = 5)
    ...
    std::string getModelName() const override { return "Alexnet"; }
