...
#ifndef YOLO26L_OBB_FACTORY_HPP
#define YOLO26L_OBB_FACTORY_HPP
...
class Yolo26l_obbFactory : public IOBBFactory {
public:
    explicit Yolo26l_obbFactory(float score_threshold = 0.3f)
