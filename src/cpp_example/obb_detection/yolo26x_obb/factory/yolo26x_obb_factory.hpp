/**
 * @file yolo26x_obb_factory.hpp
 * @brief Yolo26x_obb Abstract Factory implementation
 * 
 * Creates matching components for YOLOv26 OBB (Oriented Bounding Box) detection.
 */

#ifndef YOLO26X_OBB_FACTORY_HPP
#define YOLO26X_OBB_FACTORY_HPP
...
class Yolo26x_obbFactory : public IOBBFactory {
public:
    explicit Yolo26x_obbFactory(float score_threshold = 0.3f)
    ...
    std::string getModelName() const override { return "Yolo26x_obb"; }
