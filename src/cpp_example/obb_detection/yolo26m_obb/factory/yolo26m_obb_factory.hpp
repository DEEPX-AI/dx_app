/**
 * @file yolo26m_obb_factory.hpp
 * @brief Yolo26m_obb Abstract Factory implementation
 * 
 * Creates matching components for YOLOv26 OBB (Oriented Bounding Box) detection.
 */

#ifndef YOLO26M_OBB_FACTORY_HPP
#define YOLO26M_OBB_FACTORY_HPP
...
class Yolo26m_obbFactory : public IOBBFactory {
public:
    explicit Yolo26m_obbFactory(float score_threshold = 0.3f)
    ...
    std::string getModelName() const override { return "Yolo26m_obb"; }
