/**
 * @file yolo26s_obb_factory.hpp
 * @brief Yolo26s_obb Abstract Factory implementation
 * 
 * Creates matching components for YOLOv26 OBB (Oriented Bounding Box) detection.
 */

#ifndef YOLO26S_OBB_FACTORY_HPP
#define YOLO26S_OBB_FACTORY_HPP
...
class Yolo26s_obbFactory : public IOBBFactory {
public:
    explicit Yolo26s_obbFactory(float score_threshold = 0.3f)
    ...
    std::string getModelName() const override { return "Yolo26s_obb"; }
