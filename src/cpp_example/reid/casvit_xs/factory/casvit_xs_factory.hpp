...
#ifndef CASVIT_XS_FACTORY_HPP
#define CASVIT_XS_FACTORY_HPP
...
class Casvit_xsFactory : public IEmbeddingFactory {
public:
    Casvit_xsFactory() = default;
    ...
    std::string getModelName() const override { return "Casvit_xs"; }
    std::string getTaskType() const override { return "reid"; }
};

}  // namespace dxapp

#endif  // CASVIT_XS_FACTORY_HPP
