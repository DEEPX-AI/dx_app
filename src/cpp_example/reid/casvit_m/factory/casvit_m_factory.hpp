...
#ifndef CASVIT_M_FACTORY_HPP
#define CASVIT_M_FACTORY_HPP
...
class Casvit_mFactory : public IEmbeddingFactory {
public:
    Casvit_mFactory() = default;
