/**
 * @file yolov5n_6_1_factory.hpp
 * @brief YOLOv5n_6_1 Abstract Factory implementation
 */

#ifndef YOLOV5N_6_1_FACTORY_HPP
#define YOLOV5N_6_1_FACTORY_HPP
...
class YOLOv5n_6_1Factory : public IDetectionFactory {
public:
    YOLOv5n_6_1Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5n_6_1"; }
