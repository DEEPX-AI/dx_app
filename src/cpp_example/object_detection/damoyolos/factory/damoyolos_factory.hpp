...
class DamoYOLOsFactory : public IDetectionFactory {
public:
    DamoYOLOsFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-s"; }
