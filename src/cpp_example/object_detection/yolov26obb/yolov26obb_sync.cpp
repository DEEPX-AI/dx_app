...
/**
 * @brief Synchronous post-processing example for YOLOv26Obb object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv26Obb Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv26ObbPostProcess& post_processor, ProfilingMetrics& metrics,
