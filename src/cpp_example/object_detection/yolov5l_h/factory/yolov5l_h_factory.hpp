/**
 * @file yolov5l_h_factory.hpp
 * @brief YOLOv5l_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5L_h_FACTORY_HPP
#define YOLOV5L_h_FACTORY_HPP
...
class YOLOv5l_hFactory : public IDetectionFactory {
public:
    YOLOv5l_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5l_h"; }
