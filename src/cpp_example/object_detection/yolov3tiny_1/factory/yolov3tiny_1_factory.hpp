/**
 * @file yolov3tiny_1_factory.hpp
 * @brief YOLOv3tiny_1 Abstract Factory implementation
 * 
 */

#ifndef YOLOV3TINY_1_FACTORY_HPP
#define YOLOV3TINY_1_FACTORY_HPP
...
class YOLOv3tiny_1Factory : public IDetectionFactory {
public:
    YOLOv3tiny_1Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv3tiny_1"; }
...
#endif  // YOLOV3TINY_1_FACTORY_HPP
