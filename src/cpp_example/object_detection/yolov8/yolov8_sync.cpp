...
/**
 * @brief Synchronous post-processing example for YOLOv8 object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv8 Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv8PostProcess& post_processor, ProfilingMetrics& metrics,
