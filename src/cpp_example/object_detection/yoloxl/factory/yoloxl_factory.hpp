/**
 * @file yoloxl_factory.hpp
 * @brief YOLOXl Abstract Factory implementation
 */

#ifndef YOLOXL_FACTORY_HPP
#define YOLOXL_FACTORY_HPP
...
class YOLOXlFactory : public IDetectionFactory {
public:
    YOLOXlFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOXl"; }
