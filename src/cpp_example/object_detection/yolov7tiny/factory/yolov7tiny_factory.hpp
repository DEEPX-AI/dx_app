/**
 * @file yolov7tiny_factory.hpp
 * @brief YOLOv7tiny Abstract Factory implementation
 */

#ifndef YOLOV7TINY_FACTORY_HPP
#define YOLOV7TINY_FACTORY_HPP
...
class YOLOv7tinyFactory : public IDetectionFactory {
public:
    YOLOv7tinyFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7tiny"; }
