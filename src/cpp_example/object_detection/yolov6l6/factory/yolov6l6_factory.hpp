/**
 * @file yolov6l_factory.hpp
 * @brief YOLOv6l6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV6L6_FACTORY_HPP
#define YOLOV6L6_FACTORY_HPP
...
class YOLOv6lFactory : public IDetectionFactory {
public:
    YOLOv6lFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6l6"; }
