 ...
 * @brief YOLOv6l Abstract Factory implementation
 * 
 */

#ifndef YOLOV6L_FACTORY_HPP
#define YOLOV6L_FACTORY_HPP
...
public:
    ...
    std::string getModelName() const override { return "YOLOv6l"; }
