/**
 * @file yoloxx_factory.hpp
 * @brief YOLOXx Abstract Factory implementation
 */

#ifndef YOLOXX_FACTORY_HPP
#define YOLOXX_FACTORY_HPP
...
class YOLOXxFactory : public IDetectionFactory {
public:
    YOLOXxFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOXx"; }
