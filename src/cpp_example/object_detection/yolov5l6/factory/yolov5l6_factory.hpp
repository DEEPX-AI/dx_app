/**
 * @file yolov5l6_factory.hpp
 * @brief YOLOv5l6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5L6_FACTORY_HPP
#define YOLOV5L6_FACTORY_HPP
...
class YOLOv5l6Factory : public IDetectionFactory {
public:
    YOLOv5l6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5l6"; }
