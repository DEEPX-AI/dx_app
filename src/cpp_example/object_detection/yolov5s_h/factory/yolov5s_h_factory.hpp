/**
 * @file yolov5s_h_factory.hpp
 * @brief YOLOv5s_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_h_FACTORY_HPP
#define YOLOV5S_h_FACTORY_HPP
...
class YOLOv5s_hFactory : public IDetectionFactory {
public:
    YOLOv5s_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s_h"; }
