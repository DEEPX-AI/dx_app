/**
 * @file yolov5s_4_factory.hpp
 * @brief YOLOv5s_4 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_4_FACTORY_HPP
#define YOLOV5S_4_FACTORY_HPP
...
class YOLOv5s_4Factory : public IDetectionFactory {
public:
    YOLOv5s_4Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s_4"; }
