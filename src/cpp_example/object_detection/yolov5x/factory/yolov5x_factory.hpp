/**
 * @file yolov5x_factory.hpp
 * @brief YOLOv5x Abstract Factory implementation
 * 
 */

#ifndef YOLOV5X_FACTORY_HPP
#define YOLOV5X_FACTORY_HPP
...
class YOLOv5xFactory : public IDetectionFactory {
public:
    YOLOv5xFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5x"; }
