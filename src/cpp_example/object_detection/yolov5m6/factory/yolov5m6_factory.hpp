/**
 * @file yolov5m6_factory.hpp
 * @brief YOLOv5m6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M6_FACTORY_HPP
#define YOLOV5M6_FACTORY_HPP
...
class YOLOv5m6Factory : public IDetectionFactory {
public:
    YOLOv5m6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m6"; }
