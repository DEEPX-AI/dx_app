/**
 * @file yolov5l_factory.hpp
 * @brief YOLOv5l Abstract Factory implementation
 */

#ifndef YOLOV5L_FACTORY_HPP
#define YOLOV5L_FACTORY_HPP
...
class YOLOv5lFactory : public IDetectionFactory {
public:
    YOLOv5lFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5l"; }
