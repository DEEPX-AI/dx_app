...
class DamoYOLOlFactory : public IDetectionFactory {
public:
    DamoYOLOlFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-l"; }
