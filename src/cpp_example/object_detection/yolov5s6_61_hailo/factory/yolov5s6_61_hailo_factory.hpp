/**
 * @file yolov5s6_61_hailo_factory.hpp
 * @brief YOLOv5s6_61_hailo Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S6_61_HAILO_FACTORY_HPP
#define YOLOV5S6_61_HAILO_FACTORY_HPP
...
class YOLOv5s6_61_hailoFactory : public IDetectionFactory {
public:
    YOLOv5s6_61_hailoFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s6_61_hailo"; }
...
#endif  // YOLOV5S6_61_HAILO_FACTORY_HPP
