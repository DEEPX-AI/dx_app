/**
 * @file yolov11n_factory.hpp
 * @brief YOLOv11 Abstract Factory implementation
 */

#ifndef YOLOV11N_FACTORY_HPP
#define YOLOV11N_FACTORY_HPP
...
class YOLOv11Factory : public IDetectionFactory {
public:
    YOLOv11Factory(float score_threshold = 0.3f,
    ...
    PostprocessorPtr<DetectionResult> createPostprocessor(
        ...
        return std::make_unique<YOLOv11Postprocessor>(
