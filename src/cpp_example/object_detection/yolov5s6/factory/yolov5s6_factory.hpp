/**
 * @file yolov5s6_factory.hpp
 * @brief YOLOv5s6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S6_FACTORY_HPP
#define YOLOV5S6_FACTORY_HPP
...
class YOLOv5s6Factory : public IDetectionFactory {
public:
    YOLOv5s6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s6"; }
