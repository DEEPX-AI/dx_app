/**
 * @file yoloxtiny_factory.hpp
 * @brief YOLOXtiny Abstract Factory implementation
 */

#ifndef YOLOXTINY_FACTORY_HPP
#define YOLOXTINY_FACTORY_HPP
...
class YOLOXtinyFactory : public IDetectionFactory {
public:
    YOLOXtinyFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOXtiny"; }
