/**
 * @file yolo26m_factory.hpp
 * @brief Yolo26m Abstract Factory implementation
 */

#ifndef YOLO26M_FACTORY_HPP
#define YOLO26M_FACTORY_HPP
...
class Yolo26mFactory : public IDetectionFactory {
public:
    Yolo26mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26m"; }
