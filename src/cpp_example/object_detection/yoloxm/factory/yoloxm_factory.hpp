/**
 * @file yoloxm_factory.hpp
 * @brief YOLOXm Abstract Factory implementation
 */

#ifndef YOLOXM_FACTORY_HPP
#define YOLOXM_FACTORY_HPP
...
class YOLOXmFactory : public IDetectionFactory {
public:
    YOLOXmFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOXm"; }
