/**
 * @file yolov5l_hailo_sync.cpp
 * @brief YOLOv5l_hailo synchronous inference example
 * 
...
int main(int argc, char* argv[]) {
    ...
    dxapp::SyncDetectionRunner<dxapp::YOLOv5l_hailoFactory> runner(std::move(factory));
