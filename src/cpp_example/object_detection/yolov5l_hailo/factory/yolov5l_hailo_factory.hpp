/**
 * @file yolov5l_hailo_factory.hpp
 * @brief YOLOv5l_hailo Abstract Factory implementation
 * 
 */

#ifndef YOLOV5L_HAILO_FACTORY_HPP
#define YOLOV5L_HAILO_FACTORY_HPP
...
class YOLOv5l_hailoFactory : public IDetectionFactory {
public:
    YOLOv5l_hailoFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5l_hailo"; }
...
#endif  // YOLOV5L_HAILO_FACTORY_HPP
