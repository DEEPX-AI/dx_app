/**
 * @file yolov8x_factory.hpp
 * @brief YOLOv8x Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV8X_FACTORY_HPP
#define YOLOV8X_FACTORY_HPP
...
class YOLOv8xFactory : public IDetectionFactory {
public:
    YOLOv8xFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv8x"; }
