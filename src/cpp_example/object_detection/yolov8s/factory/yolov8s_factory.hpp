/**
 * @file yolov8s_factory.hpp
 * @brief YOLOv8s Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV8S_FACTORY_HPP
#define YOLOV8S_FACTORY_HPP
...
class YOLOv8sFactory : public IDetectionFactory {
public:
    YOLOv8sFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv8s"; }
