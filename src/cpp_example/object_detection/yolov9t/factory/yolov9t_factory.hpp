/**
 * @file yolov9t_factory.hpp
 * @brief YOLOv9t Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV9T_FACTORY_HPP
#define YOLOV9T_FACTORY_HPP
...
class YOLOv9tFactory : public IDetectionFactory {
public:
    YOLOv9tFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv9t"; }
