/**
 * @file yolov4tiny_1_factory.hpp
 * @brief YOLOv4tiny_1 Abstract Factory implementation
 * 
 */

#ifndef YOLOV4TINY_1_FACTORY_HPP
#define YOLOV4TINY_1_FACTORY_HPP
...
class YOLOv4tiny_1Factory : public IDetectionFactory {
public:
    YOLOv4tiny_1Factory(float score_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv4tiny_1"; }
...
#endif  // YOLOV4TINY_1_FACTORY_HPP
