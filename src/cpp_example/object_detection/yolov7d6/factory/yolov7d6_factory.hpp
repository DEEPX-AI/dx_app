/**
 * @file yolov7d6_factory.hpp
 * @brief YOLOv7d6 Abstract Factory implementation
 */

#ifndef YOLOV7D6_FACTORY_HPP
#define YOLOV7D6_FACTORY_HPP
...
class YOLOv7d6Factory : public IDetectionFactory {
public:
    YOLOv7d6Factory(float obj_threshold = 0.25f,
