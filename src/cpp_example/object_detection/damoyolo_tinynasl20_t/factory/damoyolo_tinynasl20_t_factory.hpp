/**
 * @file damoyolo_tinynasl20_t_factory.hpp
 * @brief DAMO-YOLO Abstract Factory implementation
 * 
 * Uses v3-native DAMO-YOLO postprocessor with split-head format.
 */

#ifndef DAMOYOLO_TINYNASL20_T_FACTORY_HPP
#define DAMOYOLO_TINYNASL20_T_FACTORY_HPP
...
class DamoYOLO_tinynasl20_tFactory : public IDetectionFactory {
public:
    DamoYOLO_tinynasl20_tFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-TinyNASL20-t"; }
...
#endif  // DAMOYOLO_TINYNASL20_T_FACTORY_HPP
