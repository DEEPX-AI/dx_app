/**
 * @file nanodet_repvgga1_factory.hpp
 * @brief NanoDet_repvgga1 Abstract Factory implementation
 * 
 * Part of DX-APP v3.0.0 refactoring.
 * Uses v3-native NanoDet postprocessor with DFL decoding.
 */

#ifndef NANODET_REPVGGA1_FACTORY_HPP
#define NANODET_REPVGGA1_FACTORY_HPP
...
class NanoDet_repvgga1Factory : public IDetectionFactory {
public:
    NanoDet_repvgga1Factory(float score_threshold = 0.35f,
    ...
    std::string getModelName() const override { return "NanoDet_repvgga1"; }
...
#endif  // NANODET_REPVGGA1_FACTORY_HPP
