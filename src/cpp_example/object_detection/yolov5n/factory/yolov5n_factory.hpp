/**
 * @file yolov5n_factory.hpp
 * @brief YOLOv5 Abstract Factory implementation
 * 
 * Part of DX-APP v3.0.0 refactoring.
 */

#ifndef YOLOV5N_FACTORY_HPP
#define YOLOV5N_FACTORY_HPP
...
public:
    ...
    std::string getModelName() const override { return "YOLOv5"; }
