/**
 * @file yolov6n_0_2_1_nms_core_factory.hpp
 * @brief YOLOv6n_0_2_1_nms_core Abstract Factory implementation
 * 
 */

#ifndef YOLOV6N_0_2_1_NMS_CORE_FACTORY_HPP
#define YOLOV6N_0_2_1_NMS_CORE_FACTORY_HPP
...
class YOLOv6n_0_2_1_nms_coreFactory : public IDetectionFactory {
public:
    YOLOv6n_0_2_1_nms_coreFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6n_0_2_1_nms_core"; }
...
#endif  // YOLOV6N_0_2_1_NMS_CORE_FACTORY_HPP
