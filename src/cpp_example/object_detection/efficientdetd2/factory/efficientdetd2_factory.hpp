/**
 * @file efficientdetd2_factory.hpp
 * @brief Efficientdetd2 Abstract Factory implementation
 * 
 * Note: EfficientDet-specific SSD-style postprocessor
 */

#ifndef EFFICIENTDETD2_FACTORY_HPP
#define EFFICIENTDETD2_FACTORY_HPP
...
class Efficientdetd2Factory : public IDetectionFactory {
public:
    Efficientdetd2Factory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Efficientdetd2"; }
...
#endif  // EFFICIENTDETD2_FACTORY_HPP
