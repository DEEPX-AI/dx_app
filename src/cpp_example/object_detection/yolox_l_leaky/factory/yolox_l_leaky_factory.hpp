/**
 * @file yolox_l_leaky_factory.hpp
 * @brief YOLOX_l_leaky Abstract Factory implementation
 */

#ifndef YOLOX_L_LEAKY_FACTORY_HPP
#define YOLOX_L_LEAKY_FACTORY_HPP
...
class YOLOX_l_leakyFactory : public IDetectionFactory {
public:
    YOLOX_l_leakyFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOX_l_leaky"; }
...
#endif  // YOLOX_L_LEAKY_FACTORY_HPP
