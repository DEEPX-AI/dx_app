...
/**
 * @brief Synchronous post-processing example for YOLOv12 object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv12 Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv12PostProcess& post_processor, ProfilingMetrics& metrics,
