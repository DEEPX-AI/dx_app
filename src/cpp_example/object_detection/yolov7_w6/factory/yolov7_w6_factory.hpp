/**
 * @file yolov7_w6_factory.hpp
 * @brief YOLOv7_w6 Abstract Factory implementation
 */

#ifndef YOLOV7_W6_FACTORY_HPP
#define YOLOV7_W6_FACTORY_HPP
...
class YOLOv7_w6Factory : public IDetectionFactory {
public:
    YOLOv7_w6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7_w6"; }
