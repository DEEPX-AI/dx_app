/**
 * @file yolov6n_0_1_0_factory.hpp
 * @brief YOLOv6n_0_1_0 Abstract Factory implementation
 * 
 * Part of DX-APP v3.0.0 refactoring.
 */

#ifndef YOLOV6N_0_1_0_FACTORY_HPP
#define YOLOV6N_0_1_0_FACTORY_HPP
...
class YOLOv6n_0_1_0Factory : public IDetectionFactory {
public:
    YOLOv6n_0_1_0Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6n_0_1_0"; }
...
#endif  // YOLOV6N_0_1_0_FACTORY_HPP
