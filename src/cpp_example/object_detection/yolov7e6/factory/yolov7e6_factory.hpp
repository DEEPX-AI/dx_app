/**
 * @file yolov7e6_factory.hpp
 * @brief YOLOv7e6 Abstract Factory implementation
 */

#ifndef YOLOV7E6_FACTORY_HPP
#define YOLOV7E6_FACTORY_HPP
...
class YOLOv7e6Factory : public IDetectionFactory {
public:
    YOLOv7e6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7e6"; }
