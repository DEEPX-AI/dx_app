/**
 * @file yolov7_wo_decoding_factory.hpp
 * @brief YOLOv7_wo_decoding Abstract Factory implementation
 */

#ifndef YOLOV7_WO_DECODING_FACTORY_HPP
#define YOLOV7_WO_DECODING_FACTORY_HPP
...
class YOLOv7_wo_decodingFactory : public IDetectionFactory {
public:
    YOLOv7_wo_decodingFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7_wo_decoding"; }
...
#endif  // YOLOV7_WO_DECODING_FACTORY_HPP
