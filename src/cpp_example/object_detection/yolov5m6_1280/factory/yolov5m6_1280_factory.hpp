/**
 * @file yolov5m6_1280_factory.hpp
 * @brief YOLOv5m6_1280 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M6_1280_FACTORY_HPP
#define YOLOV5M6_1280_FACTORY_HPP
...
class YOLOv5m6_1280Factory : public IDetectionFactory {
public:
    YOLOv5m6_1280Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m6_1280"; }
...
#endif  // YOLOV5M6_1280_FACTORY_HPP
