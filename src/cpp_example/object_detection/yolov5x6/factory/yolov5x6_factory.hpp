/**
 * @file yolov5x6_factory.hpp
 * @brief YOLOv5x6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5X6_FACTORY_HPP
#define YOLOV5X6_FACTORY_HPP
...
class YOLOv5x6Factory : public IDetectionFactory {
public:
    YOLOv5x6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5x6"; }
