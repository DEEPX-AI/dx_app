/**
 * @file yolov10n_factory.hpp
 * @brief YOLOv10 Abstract Factory implementation
 */

#ifndef YOLOV10N_FACTORY_HPP
#define YOLOV10N_FACTORY_HPP
...
public:
    YOLOv10Factory(float score_threshold = 0.3f,
