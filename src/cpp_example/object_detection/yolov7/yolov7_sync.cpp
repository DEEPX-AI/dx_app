...
/**
 * @brief Synchronous post-processing example for YOLOv7 object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv7 Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv7PostProcess& post_processor, ProfilingMetrics& metrics,
