/**
 * @file yolov5s_factory.hpp
 * @brief YOLOv5s Abstract Factory implementation
 * 
 * Part of DX-APP v3.0.0 refactoring.
 */

#ifndef YOLOV5S_FACTORY_HPP
#define YOLOV5S_FACTORY_HPP
...
class YOLOv5sFactory : public IDetectionFactory {
public:
    YOLOv5sFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s"; }
