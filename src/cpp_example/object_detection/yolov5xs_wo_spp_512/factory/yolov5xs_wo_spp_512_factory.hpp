/**
 * @file yolov5xs_wo_spp_512_factory.hpp
 * @brief YOLOv5xs_wo_spp_512 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5XS_WO_SPP_512_FACTORY_HPP
#define YOLOV5XS_WO_SPP_512_FACTORY_HPP
...
class YOLOv5xs_wo_spp_512Factory : public IDetectionFactory {
public:
    YOLOv5xs_wo_spp_512Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5xs_wo_spp_512"; }
...
#endif  // YOLOV5XS_WO_SPP_512_FACTORY_HPP
