/**
 * @file yolov9s_factory.hpp
 * @brief YOLOv9s Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV9S_FACTORY_HPP
#define YOLOV9S_FACTORY_HPP
...
class YOLOv9sFactory : public IDetectionFactory {
public:
    YOLOv9sFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv9s"; }
