/**
 * @file yolov5m_6_1_factory.hpp
 * @brief YOLOv5m_6_1 Abstract Factory implementation
 * 
 * Part of DX-APP v3.0.0 refactoring.
 */

#ifndef YOLOV5M_6_1_FACTORY_HPP
#define YOLOV5M_6_1_FACTORY_HPP
...
class YOLOv5m_6_1Factory : public IDetectionFactory {
public:
    YOLOv5m_6_1Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m_6_1"; }
