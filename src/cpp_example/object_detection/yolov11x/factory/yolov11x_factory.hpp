/**
 * @file yolov11x_factory.hpp
 * @brief YOLOv11x Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV11X_FACTORY_HPP
#define YOLOV11X_FACTORY_HPP
...
class YOLOv11xFactory : public IDetectionFactory {
public:
    YOLOv11xFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv11x"; }
