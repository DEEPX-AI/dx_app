/**
 * @file yolov9m_factory.hpp
 * @brief YOLOv9m Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV9M_FACTORY_HPP
#define YOLOV9M_FACTORY_HPP
...
class YOLOv9mFactory : public IDetectionFactory {
public:
    YOLOv9mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv9m"; }
