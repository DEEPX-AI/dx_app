/**
 * @file yolov3_2_factory.hpp
 * @brief YOLOv3_2 Abstract Factory implementation
 * 
 */

#ifndef YOLOV3_2_FACTORY_HPP
#define YOLOV3_2_FACTORY_HPP
...
class YOLOv3_2Factory : public IDetectionFactory {
public:
    YOLOv3_2Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv3_2"; }
