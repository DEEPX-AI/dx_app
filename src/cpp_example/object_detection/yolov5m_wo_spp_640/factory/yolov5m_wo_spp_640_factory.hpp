/**
 * @file yolov5m_wo_spp_640_factory.hpp
 * @brief YOLOv5m_wo_spp_640 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M_WO_SPP_640_FACTORY_HPP
#define YOLOV5M_WO_SPP_640_FACTORY_HPP
...
class YOLOv5m_wo_spp_640Factory : public IDetectionFactory {
public:
    YOLOv5m_wo_spp_640Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m_wo_spp_640"; }
...
#endif  // YOLOV5M_WO_SPP_640_FACTORY_HPP
