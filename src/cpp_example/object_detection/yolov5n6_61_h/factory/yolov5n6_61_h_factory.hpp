/**
 * @file yolov5n6_61_h_factory.hpp
 * @brief YOLOv5n6_61_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5N6_61_h_FACTORY_HPP
#define YOLOV5N6_61_h_FACTORY_HPP
...
class YOLOv5n6_61_hFactory : public IDetectionFactory {
public:
    YOLOv5n6_61_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5n6_61_h"; }
...
#endif  // YOLOV5N6_61_h_FACTORY_HPP
