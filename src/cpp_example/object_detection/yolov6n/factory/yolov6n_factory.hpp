/**
 * @file yolov6n_factory.hpp
 * @brief YOLOv6n Abstract Factory implementation
 * 
 */

#ifndef YOLOV6N_FACTORY_HPP
#define YOLOV6N_FACTORY_HPP
...
class YOLOv6nFactory : public IDetectionFactory {
public:
    YOLOv6nFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6n"; }
