/**
 * @file yolov7e6e_factory.hpp
 * @brief YOLOv7e6e Abstract Factory implementation
 */

#ifndef YOLOV7E6E_FACTORY_HPP
#define YOLOV7E6E_FACTORY_HPP
...
class YOLOv7e6eFactory : public IDetectionFactory {
public:
    YOLOv7e6eFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7e6e"; }
