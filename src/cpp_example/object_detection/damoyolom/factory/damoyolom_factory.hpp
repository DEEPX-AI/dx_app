...
#ifndef DAMOYOLOM_FACTORY_HPP
#define DAMOYOLOM_FACTORY_HPP
...
class DamoYOLOmFactory : public IDetectionFactory {
public:
    DamoYOLOmFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-m"; }
