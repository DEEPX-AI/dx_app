/**
 * @file yolov5m_hailo_factory.hpp
 * @brief YOLOv5m_hailo Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M_HAILO_FACTORY_HPP
#define YOLOV5M_HAILO_FACTORY_HPP
...
class YOLOv5m_hailoFactory : public IDetectionFactory {
public:
    YOLOv5m_hailoFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m_hailo"; }
...
#endif  // YOLOV5M_HAILO_FACTORY_HPP
