/**
 * @file damoyolo_tinynasl35_m_factory.hpp
...
#ifndef DAMOYOLO_TINYNASL35_M_FACTORY_HPP
#define DAMOYOLO_TINYNASL35_M_FACTORY_HPP
...
class DamoYOLO_tinynasl35_mFactory : public IDetectionFactory {
public:
    DamoYOLO_tinynasl35_mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-TinyNASL35-m"; }
...
#endif  // DAMOYOLO_TINYNASL35_M_FACTORY_HPP
