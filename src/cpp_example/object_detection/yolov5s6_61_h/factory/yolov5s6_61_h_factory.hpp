/**
 * @file yolov5s6_61_h_factory.hpp
 * @brief YOLOv5s6_61_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S6_61_h_FACTORY_HPP
#define YOLOV5S6_61_h_FACTORY_HPP
...
class YOLOv5s6_61_hFactory : public IDetectionFactory {
public:
    YOLOv5s6_61_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s6_61_h"; }
...
#endif  // YOLOV5S6_61_h_FACTORY_HPP
