/**
 * @file yolox_s_wide_leaky_factory.hpp
 * @brief YOLOX_s_wide_leaky Abstract Factory implementation
 */

#ifndef YOLOX_S_WIDE_LEAKY_FACTORY_HPP
#define YOLOX_S_WIDE_LEAKY_FACTORY_HPP
...
class YOLOX_s_wide_leakyFactory : public IDetectionFactory {
public:
    YOLOX_s_wide_leakyFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOX_s_wide_leaky"; }
...
#endif  // YOLOX_S_WIDE_LEAKY_FACTORY_HPP
