/**
 * @file yolov5n6_factory.hpp
 * @brief YOLOv5n6 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5N6_FACTORY_HPP
#define YOLOV5N6_FACTORY_HPP
...
class YOLOv5n6Factory : public IDetectionFactory {
public:
    YOLOv5n6Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5n6"; }
