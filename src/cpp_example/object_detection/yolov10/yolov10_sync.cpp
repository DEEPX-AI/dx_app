...
/**
 * @brief Synchronous post-processing example for YOLOv10 object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv10 Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv10PostProcess& post_processor, ProfilingMetrics& metrics,
