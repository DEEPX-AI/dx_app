/**
 * @file yolo26x_factory.hpp
 * @brief Yolo26x Abstract Factory implementation
 */

#ifndef YOLO26X_FACTORY_HPP
#define YOLO26X_FACTORY_HPP
...
class Yolo26xFactory : public IDetectionFactory {
public:
    Yolo26xFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "Yolo26x"; }
