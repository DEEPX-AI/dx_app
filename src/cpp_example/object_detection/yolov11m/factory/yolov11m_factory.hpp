/**
 * @file yolov11m_factory.hpp
 * @brief YOLOv11m Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV11M_FACTORY_HPP
#define YOLOV11M_FACTORY_HPP
...
class YOLOv11mFactory : public IDetectionFactory {
public:
    YOLOv11mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv11m"; }
