/**
 * @file yolov5s_bbox_decoding_only_640_factory.hpp
 * @brief YOLOv5s_bbox_decoding_only_640 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_BBOX_DECODING_ONLY_640_FACTORY_HPP
#define YOLOV5S_BBOX_DECODING_ONLY_640_FACTORY_HPP
...
class YOLOv5s_bbox_decoding_only_640Factory : public IDetectionFactory {
public:
    YOLOv5s_bbox_decoding_only_640Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s_bbox_decoding_only_640"; }
...
#endif  // YOLOV5S_BBOX_DECODING_ONLY_640_FACTORY_HPP
