...
/**
 * @brief Synchronous post-processing example for YOLOv9 object detection model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv9 Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv9PostProcess& post_processor, ProfilingMetrics& metrics,
