/**
 * @file damoyolo_tinynasl20_m_factory.hpp
 * @brief DAMO-YOLO Abstract Factory implementation
 *
 * Uses v3-native DAMO-YOLO postprocessor with split-head format.
 */

#ifndef DAMOYOLO_TINYNASL20_M_FACTORY_HPP
#define DAMOYOLO_TINYNASL20_M_FACTORY_HPP
...
class DamoYOLO_tinynasl20_mFactory : public IDetectionFactory {
public:
    DamoYOLO_tinynasl20_mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "DAMO-YOLO-TinyNASL20-m"; }
...
#endif  // DAMOYOLO_TINYNASL20_M_FACTORY_HPP
