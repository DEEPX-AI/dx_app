/**
 * @file yolov5s_c3tr_640_sync.cpp
 * @brief YOLOv5s_c3tr_640 synchronous inference example
 * 
...
int main(int argc, char* argv[]) {
    ...
    dxapp::SyncDetectionRunner<dxapp::YOLOv5s_c3tr_640Factory> runner(std::move(factory));
