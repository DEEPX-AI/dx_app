/**
 * @file yolov5s_c3tr_640_factory.hpp
 * @brief YOLOv5s_c3tr_640 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_C3TR_640_FACTORY_HPP
#define YOLOV5S_C3TR_640_FACTORY_HPP
...
class YOLOv5s_c3tr_640Factory : public IDetectionFactory {
public:
    YOLOv5s_c3tr_640Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s_c3tr_640"; }
...
#endif  // YOLOV5S_C3TR_640_FACTORY_HPP
