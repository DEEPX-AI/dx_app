/**
 * @file yolov3_gluon_608_factory.hpp
 * @brief YOLOv3_gluon_608 Abstract Factory implementation
 * 
 */

#ifndef YOLOV3_GLUON_608_FACTORY_HPP
#define YOLOV3_GLUON_608_FACTORY_HPP
...
class YOLOv3_gluon_608Factory : public IDetectionFactory {
public:
    YOLOv3_gluon_608Factory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv3_gluon_608"; }
...
#endif  // YOLOV3_GLUON_608_FACTORY_HPP
