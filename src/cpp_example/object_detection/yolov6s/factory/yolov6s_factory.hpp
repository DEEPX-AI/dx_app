/**
 * @file yolov6s_factory.hpp
 * @brief YOLOv6s Abstract Factory implementation
 * 
 */

#ifndef YOLOV6S_FACTORY_HPP
#define YOLOV6S_FACTORY_HPP
...
class YOLOv6sFactory : public IDetectionFactory {
public:
    YOLOv6sFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6s"; }
