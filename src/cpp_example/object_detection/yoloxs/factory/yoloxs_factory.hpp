/**
 * @file yoloxs_factory.hpp
 * @brief YOLOX Abstract Factory implementation
 */

#ifndef YOLOXS_FACTORY_HPP
#define YOLOXS_FACTORY_HPP
...
public:
    YOLOXFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOX"; }
