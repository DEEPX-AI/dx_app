/**
 * @file yolov7x_factory.hpp
 * @brief YOLOv7x Abstract Factory implementation
 */

#ifndef YOLOV7X_FACTORY_HPP
#define YOLOV7X_FACTORY_HPP
...
class YOLOv7xFactory : public IDetectionFactory {
public:
    YOLOv7xFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7x"; }
