/**
 * @file yolov5m6_61_h_factory.hpp
 * @brief YOLOv5m6_61_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M6_61_h_FACTORY_HPP
#define YOLOV5M6_61_h_FACTORY_HPP
...
class YOLOv5m6_61_hFactory : public IDetectionFactory {
public:
    YOLOv5m6_61_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m6_61_h"; }
...
#endif  // YOLOV5M6_61_h_FACTORY_HPP
