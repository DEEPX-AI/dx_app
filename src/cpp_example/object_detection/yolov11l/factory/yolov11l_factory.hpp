/**
 * @file yolov11l_factory.hpp
 * @brief YOLOv11l Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV11L_FACTORY_HPP
#define YOLOV11L_FACTORY_HPP
...
class YOLOv11lFactory : public IDetectionFactory {
public:
    YOLOv11lFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv11l"; }
