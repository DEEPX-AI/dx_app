/**
 * @file yolov5s_hailo_factory.hpp
 * @brief YOLOv5s_hailo Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_HAILO_FACTORY_HPP
#define YOLOV5S_HAILO_FACTORY_HPP
...
class YOLOv5s_hailoFactory : public IDetectionFactory {
public:
    YOLOv5s_hailoFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5s_hailo"; }
...
#endif  // YOLOV5S_HAILO_FACTORY_HPP
