/**
 * @file yolov8m_factory.hpp
 * @brief YOLOv8m Abstract Factory implementation
 * 
 * Note: YOLOv8 is anchor-free, no obj_threshold needed
 */

#ifndef YOLOV8M_FACTORY_HPP
#define YOLOV8M_FACTORY_HPP
...
class YOLOv8mFactory : public IDetectionFactory {
public:
    YOLOv8mFactory(float score_threshold = 0.3f,
    ...
    std::string getModelName() const override { return "YOLOv8m"; }
