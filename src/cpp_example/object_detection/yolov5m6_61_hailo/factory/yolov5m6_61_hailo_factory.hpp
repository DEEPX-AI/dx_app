/**
 * @file yolov5m6_61_hailo_factory.hpp
 * @brief YOLOv5m6_61_hailo Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M6_61_HAILO_FACTORY_HPP
#define YOLOV5M6_61_HAILO_FACTORY_HPP
...
class YOLOv5m6_61_hailoFactory : public IDetectionFactory {
public:
    YOLOv5m6_61_hailoFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m6_61_hailo"; }
...
#endif  // YOLOV5M6_61_HAILO_FACTORY_HPP
