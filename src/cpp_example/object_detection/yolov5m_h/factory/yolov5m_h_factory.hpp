/**
 * @file yolov5m_h_factory.hpp
 * @brief YOLOv5m_h Abstract Factory implementation
 * 
 */

#ifndef YOLOV5M_h_FACTORY_HPP
#define YOLOV5M_h_FACTORY_HPP
...
class YOLOv5m_hFactory : public IDetectionFactory {
public:
    YOLOv5m_hFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv5m_h"; }
