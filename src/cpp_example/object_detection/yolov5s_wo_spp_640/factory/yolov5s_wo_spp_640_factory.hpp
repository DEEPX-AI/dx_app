/**
 * @file yolov5s_wo_spp_640_factory.hpp
 * @brief YOLOv5s_wo_spp_640 Abstract Factory implementation
 * 
 */

#ifndef YOLOV5S_WO_SPP_640_FACTORY_HPP
#define YOLOV5S_WO_SPP_640_FACTORY_HPP
...
class YOLOv5s_wo_spp_640Factory : public IDetectionFactory {
public:
    YOLOv5s_wo_spp_640Factory(float obj_threshold = 0.25f,
    ...
    void loadConfig(const dxapp::ModelConfig& config) override {
        ...
        max_nms_candidates_ = config.get<int>("max_nms_candidates", max_nms_candidates_);
        class_names_ = config.get_string_list("class_names");
        num_classes_ = config.get<int>("num_classes", num_classes_);
    }

    std::string getModelName() const override { return "YOLOv5s_wo_spp_640"; }
...
#endif  // YOLOV5S_WO_SPP_640_FACTORY_HPP
