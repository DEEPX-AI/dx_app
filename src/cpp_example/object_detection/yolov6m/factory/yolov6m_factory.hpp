/**
 * @file yolov6m_factory.hpp
 * @brief YOLOv6m Abstract Factory implementation
 * 
 */

#ifndef YOLOV6M_FACTORY_HPP
#define YOLOV6M_FACTORY_HPP
...
class YOLOv6mFactory : public IDetectionFactory {
public:
    YOLOv6mFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv6m"; }
