/**
 * @file yolov5n6_61_hailo_sync.cpp
 * @brief YOLOv5n6_61_hailo synchronous inference example
 * 
...
int main(int argc, char* argv[]) {
    ...
    dxapp::SyncDetectionRunner<dxapp::YOLOv5n6_61_hailoFactory> runner(std::move(factory));
