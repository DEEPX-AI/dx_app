/**
 * @file yolov3tiny_1_ppu_factory.hpp
 * @brief YOLOv3tiny_1_ppu Abstract Factory implementation
 */

#ifndef YOLOV3TINY_1_PPU_FACTORY_HPP
#define YOLOV3TINY_1_PPU_FACTORY_HPP
...
class YOLOv3tiny_1_ppuFactory : public IDetectionFactory {
public:
    YOLOv3tiny_1_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv3tiny_1_ppu"; }
...
#endif  // YOLOV3TINY_1_PPU_FACTORY_HPP
