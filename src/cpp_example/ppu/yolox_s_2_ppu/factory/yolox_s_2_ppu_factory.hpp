/**
 * @file yolox_s_2_ppu_factory.hpp
 * @brief YOLOX_s_2_ppu Abstract Factory implementation
 */

#ifndef YOLOX_S_2_PPU_FACTORY_HPP
#define YOLOX_S_2_PPU_FACTORY_HPP
...
class YOLOX_s_2_ppuFactory : public IDetectionFactory {
public:
    YOLOX_s_2_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOX_s_2_ppu"; }
...
#endif  // YOLOX_S_2_PPU_FACTORY_HPP
