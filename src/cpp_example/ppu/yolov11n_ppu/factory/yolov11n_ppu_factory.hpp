...
class YOLOv11n_ppuFactory : public IDetectionFactory {
public:
    YOLOv11n_ppuFactory(float obj_threshold = 0.25f,
...
#endif  // YOLOV11N_PPU_FACTORY_HPP
