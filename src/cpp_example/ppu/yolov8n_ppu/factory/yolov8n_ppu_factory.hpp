/**
 * @file yolov8n_ppu_factory.hpp
 * @brief YOLOv8N-PPU Abstract Factory implementation
 *
 * YOLOv8 PPU uses anchor-free decoding (no anchor tables needed).
 */

#ifndef YOLOV8N_PPU_FACTORY_HPP
#define YOLOV8N_PPU_FACTORY_HPP
...
class YOLOv8n_ppuFactory : public IDetectionFactory {
public:
    YOLOv8n_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv8N-PPU"; }
