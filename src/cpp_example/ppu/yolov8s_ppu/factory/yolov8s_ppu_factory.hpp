/**
 * @file yolov8s_ppu_factory.hpp
 * @brief YOLOv8S-PPU Abstract Factory implementation
 *
 * YOLOv8 PPU uses anchor-free decoding (no anchor tables needed).
 */

#ifndef YOLOV8S_PPU_FACTORY_HPP
#define YOLOV8S_PPU_FACTORY_HPP
...
class YOLOv8s_ppuFactory : public IDetectionFactory {
public:
    YOLOv8s_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv8S-PPU"; }
