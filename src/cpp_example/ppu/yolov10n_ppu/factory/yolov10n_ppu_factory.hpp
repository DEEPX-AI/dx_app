/**
 * @file yolov10n_ppu_factory.hpp
 * @brief YOLOv10N-PPU Abstract Factory implementation
 *
 * YOLOv10N PPU uses anchor-free decoding (same as YOLOv8 PPU).
 */

#ifndef YOLOV10N_PPU_FACTORY_HPP
#define YOLOV10N_PPU_FACTORY_HPP
...
class YOLOv10n_ppuFactory : public IDetectionFactory {
public:
    YOLOv10n_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv10N-PPU"; }
...
#endif  // YOLOV10N_PPU_FACTORY_HPP
