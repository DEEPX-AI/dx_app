/**
 * @file yolov3_3_ppu_factory.hpp
 * @brief YOLOv3_3_ppu Abstract Factory implementation
 */

#ifndef YOLOV3_3_PPU_FACTORY_HPP
#define YOLOV3_3_PPU_FACTORY_HPP
...
class YOLOv3_3_ppuFactory : public IDetectionFactory {
public:
    YOLOv3_3_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv3_3_ppu"; }
...
#endif  // YOLOV3_3_PPU_FACTORY_HPP
