/**
 * @file yolov4_2_ppu_factory.hpp
 * @brief YOLOv4_2_ppu Abstract Factory implementation
 */

#ifndef YOLOV4_2_PPU_FACTORY_HPP
#define YOLOV4_2_PPU_FACTORY_HPP
...
class YOLOv4_2_ppuFactory : public IDetectionFactory {
public:
    YOLOv4_2_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv4_2_ppu"; }
...
#endif  // YOLOV4_2_PPU_FACTORY_HPP
