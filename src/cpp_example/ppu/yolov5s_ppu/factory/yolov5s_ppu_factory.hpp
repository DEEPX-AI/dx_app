/**
 * @file yolov5s_ppu_factory.hpp
 * @brief YOLOv5-PPU Abstract Factory implementation
 */

#ifndef YOLOV5S_PPU_FACTORY_HPP
#define YOLOV5S_PPU_FACTORY_HPP
...
class YOLOv5s_ppuFactory : public IDetectionFactory {
public:
    YOLOv5s_ppuFactory(float obj_threshold = 0.25f,
