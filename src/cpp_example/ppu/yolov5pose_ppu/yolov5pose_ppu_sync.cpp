...
/**
 * @brief Synchronous post-processing example for YOLOv5Pose Pose estimation model.
 *
...
CommandLineArgs parse_command_line(int argc, char* argv[]) {
    ...
    std::string app_name = "YOLOv5Pose PPU Post-Processing Sync Example";
...
bool process_single_frame(
    ...
    YOLOv5PosePPUPostProcess& post_processor, ProfilingMetrics& metrics,
