/**
 * @file yolov12n_ppu_factory.hpp
 * @brief YOLOv12N-PPU Abstract Factory implementation
 *
 * YOLOv12N PPU uses anchor-free decoding (same as YOLOv8 PPU).
 */

#ifndef YOLOV12N_PPU_FACTORY_HPP
#define YOLOV12N_PPU_FACTORY_HPP
...
class YOLOv12n_ppuFactory : public IDetectionFactory {
public:
    YOLOv12n_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv12N-PPU"; }
...
#endif  // YOLOV12N_PPU_FACTORY_HPP
