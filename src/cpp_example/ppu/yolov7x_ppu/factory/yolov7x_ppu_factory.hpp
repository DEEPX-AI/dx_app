/**
 * @file yolov7x_ppu_factory.hpp
 * @brief YOLOv7X-PPU Abstract Factory implementation
 *
 * YOLOv7X PPU uses anchor-based decoding (same as YOLOv7 PPU).
 */

#ifndef YOLOV7X_PPU_FACTORY_HPP
#define YOLOV7X_PPU_FACTORY_HPP
...
class YOLOv7x_ppuFactory : public IDetectionFactory {
public:
    YOLOv7x_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv7X-PPU"; }
