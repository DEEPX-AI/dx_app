/**
 * @file yolov9t_ppu_factory.hpp
 * @brief YOLOv9T-PPU Abstract Factory implementation
 *
 * YOLOv9T PPU uses anchor-free decoding (same as YOLOv8 PPU).
 */

#ifndef YOLOV9T_PPU_FACTORY_HPP
#define YOLOV9T_PPU_FACTORY_HPP
...
class YOLOv9t_ppuFactory : public IDetectionFactory {
public:
    YOLOv9t_ppuFactory(float obj_threshold = 0.25f,
    ...
    std::string getModelName() const override { return "YOLOv9T-PPU"; }
