/**
 * @file arcface_iresnet100_ms1m_factory.hpp
...
#ifndef ARCFACE_IRESNET100_MS1M_FACTORY_HPP
#define ARCFACE_IRESNET100_MS1M_FACTORY_HPP
...
class Arcface_iResNet100_ms1mFactory : public IEmbeddingFactory {
public:
    Arcface_iResNet100_ms1mFactory() = default;
    ...
    std::string getModelName() const override { return "Arcface_iResNet100_ms1m"; }
    std::string getTaskType() const override { return "embedding"; }
};

}  // namespace dxapp

#endif  // ARCFACE_IRESNET100_MS1M_FACTORY_HPP
