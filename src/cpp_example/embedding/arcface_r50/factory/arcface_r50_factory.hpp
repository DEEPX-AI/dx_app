...
#ifndef ARCFACE_R50_FACTORY_HPP
#define ARCFACE_R50_FACTORY_HPP
...
class Arcface_r50Factory : public IEmbeddingFactory {
public:
    Arcface_r50Factory() = default;
    ...
    std::string getModelName() const override { return "Arcface_r50"; }
    std::string getTaskType() const override { return "embedding"; }
};

}  // namespace dxapp

#endif  // ARCFACE_R50_FACTORY_HPP
