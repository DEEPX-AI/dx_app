/**
 * @file clip_vit_l14_quickgelu_factory.hpp
 * @brief ClipVitL14QuickgeluFactory Abstract Factory implementation
 */

#ifndef CLIP_VIT_L14_QUICKGELU_FACTORY_HPP
#define CLIP_VIT_L14_QUICKGELU_FACTORY_HPP
...
class ClipVitL14QuickgeluFactory : public IEmbeddingFactory {
public:
    ClipVitL14QuickgeluFactory() = default;
    ...
    std::string getModelName() const override { return "Clip Vit L14 Quickgelu"; }
    std::string getTaskType() const override { return "embedding"; }
};

}  // namespace dxapp

#endif  // CLIP_VIT_L14_QUICKGELU_FACTORY_HPP
