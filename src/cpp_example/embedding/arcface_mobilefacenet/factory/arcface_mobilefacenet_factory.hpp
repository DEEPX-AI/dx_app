/**
 * @file arcface_mobilefacenet_factory.hpp
...
#ifndef ARCFACE_MOBILEFACENET_FACTORY_HPP
#define ARCFACE_MOBILEFACENET_FACTORY_HPP
...
class ArcFaceMobileFaceNetFactory : public IEmbeddingFactory {
public:
    ArcFaceMobileFaceNetFactory() = default;
    ...
    std::string getModelName() const override { return "ArcFace-MobileFaceNet"; }
    std::string getTaskType() const override { return "embedding"; }
};

}  // namespace dxapp

#endif  // ARCFACE_MOBILEFACENET_FACTORY_HPP
