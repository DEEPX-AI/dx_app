/**
 * @file clip_vit_b32_256_factory.hpp
 * @brief ClipVitB32256Factory Abstract Factory implementation
 */

#ifndef CLIP_VIT_B32_256_FACTORY_HPP
#define CLIP_VIT_B32_256_FACTORY_HPP
...
class ClipVitB32256Factory : public IEmbeddingFactory {
public:
    ClipVitB32256Factory() = default;
    ...
    std::string getModelName() const override { return "Clip Vit B32 256"; }
    std::string getTaskType() const override { return "embedding"; }
};

}  // namespace dxapp

#endif  // CLIP_VIT_B32_256_FACTORY_HPP
