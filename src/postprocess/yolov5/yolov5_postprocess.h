...
/**
 * @brief YOLOv5s detection result structure
...
struct YOLOv5Result {
    ...
    float iou(const YOLOv5Result& other) const;
...
/**
 * @brief YOLOv5s post-processing class
...
class YOLOv5PostProcess {
   private:
    ...
    std::vector<YOLOv5Result> decoding_cpu_outputs(const dxrt::TensorPtrs& outputs) const;
    std::vector<YOLOv5Result> decoding_npu_outputs(const dxrt::TensorPtrs& outputs) const;
    std::vector<YOLOv5Result> apply_nms(const std::vector<YOLOv5Result>& detections) const;
   ...
   public:
    ...
    YOLOv5PostProcess(const int input_w, const int input_h, const float obj_threshold,
     ...
     */
    std::vector<YOLOv5Result> postprocess(const dxrt::TensorPtrs& outputs);
