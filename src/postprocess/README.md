...
│   ├── libdxapp_scrfd_postprocess.so
│   ├── libdxapp_scrfd_postprocess.so.1
│   ├── libdxapp_yolov5_postprocess.so
│   ├── libdxapp_yolov5_postprocess.so.1
│   ├── libdxapp_yolov5face_postprocess.so
│   ├── libdxapp_yolov5face_postprocess.so.1
│   ├── libdxapp_yolov5pose_postprocess.so
│   ├── libdxapp_yolov5pose_postprocess.so.1
│   ├── libdxapp_yolov7_postprocess.so
│   ├── libdxapp_yolov7_postprocess.so.1
│   ├── libdxapp_yolov8_postprocess.so
│   ├── libdxapp_yolov8_postprocess.so.1
│   ├── libdxapp_yolov9_postprocess.so
│   ├── libdxapp_yolov9_postprocess.so.1
│   ├── libdxapp_yolox_postprocess.so
│   └── libdxapp_yolox_postprocess.so.1
...
3. Check dependencies:
   ```bash
   ldd build/lib/libdxapp_yolov5_postprocess.so
   ```
