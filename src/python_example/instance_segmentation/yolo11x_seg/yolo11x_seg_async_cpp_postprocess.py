...
"""Yolo11x seg Asynchronous Inference Example

Usage:
    python yolo11x_seg_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo11x_segFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolo11x seg Async Inference")


def main():
    args = parse_args()
    factory = Yolo11x_segFactory()
