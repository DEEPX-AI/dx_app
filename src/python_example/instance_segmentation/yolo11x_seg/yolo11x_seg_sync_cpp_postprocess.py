...
"""Yolo11x seg Synchronous Inference Example

Usage:
    python yolo11x_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11x seg Sync Inference")
