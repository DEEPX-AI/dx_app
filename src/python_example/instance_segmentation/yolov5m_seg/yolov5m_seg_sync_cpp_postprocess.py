...
"""
Yolov5Seg Synchronous Inference Example - DX-APP v3.0.0 (C++ Postprocess)
...
def main():
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv5SegPostProcess(input_w, input_h, 0.25, 0.3, 0.45, use_ort)
