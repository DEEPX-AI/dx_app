...
"""Yolo11s seg Synchronous Inference Example

Usage:
    python yolo11s_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11s seg Sync Inference")
