...
"""Yolo11n seg Synchronous Inference Example

Usage:
    python yolo11n_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11n seg Sync Inference")
