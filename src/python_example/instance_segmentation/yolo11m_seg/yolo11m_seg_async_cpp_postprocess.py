...
"""Yolo11m seg Asynchronous Inference Example

Usage:
    python yolo11m_seg_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo11m_segFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolo11m seg Async Inference")


def main():
    args = parse_args()
    factory = Yolo11m_segFactory()
