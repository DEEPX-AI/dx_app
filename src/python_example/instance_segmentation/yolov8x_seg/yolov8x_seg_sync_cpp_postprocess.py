...
"""Yolov8x seg Synchronous Inference Example

Usage:
    python yolov8x_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolov8x seg Sync Inference")
