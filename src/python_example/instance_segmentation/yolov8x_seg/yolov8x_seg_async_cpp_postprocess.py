...
"""Yolov8x seg Asynchronous Inference Example

Usage:
    python yolov8x_seg_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8x_segFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolov8x seg Async Inference")


def main():
    args = parse_args()
    factory = Yolov8x_segFactory()
