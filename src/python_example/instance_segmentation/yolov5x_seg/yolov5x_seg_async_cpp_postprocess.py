...
"""YOLOv5x Seg Asynchronous Inference Example

Usage:
    python yolov5x_seg_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov5x_segFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("YOLOv5x Seg Async Inference")


def main():
    args = parse_args()
    factory = Yolov5x_segFactory()
