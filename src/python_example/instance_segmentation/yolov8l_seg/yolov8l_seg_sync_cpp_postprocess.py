...
"""Yolov8l seg Synchronous Inference Example

Usage:
    python yolov8l_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolov8l seg Sync Inference")
