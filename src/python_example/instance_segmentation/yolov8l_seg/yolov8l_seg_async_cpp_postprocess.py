...
"""Yolov8l seg Asynchronous Inference Example

Usage:
    python yolov8l_seg_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8l_segFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolov8l seg Async Inference")


def main():
    args = parse_args()
    factory = Yolov8l_segFactory()
