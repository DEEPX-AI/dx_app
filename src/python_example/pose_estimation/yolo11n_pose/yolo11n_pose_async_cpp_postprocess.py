...
"""Yolo11n pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11n_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo11n_poseFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolo11n pose Async Inference (C++ Postprocess)")


def main():
    args = parse_args()
    factory = Yolo11n_poseFactory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv8PosePostProcess(input_w, input_h, score_thr, nms_thr)
