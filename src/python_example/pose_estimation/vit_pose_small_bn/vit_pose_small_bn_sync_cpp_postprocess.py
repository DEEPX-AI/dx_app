...
"""VitPose Small BN Synchronous Inference Example (C++ Postprocess)

Usage:
    python vit_pose_small_bn_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("VitPose Small BN Sync Inference")
