...
"""Yolov8x pose Synchronous Inference Example (C++ Postprocess)

Usage:
    python yolov8x_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolov8x pose Sync Inference (C++ Postprocess)")
