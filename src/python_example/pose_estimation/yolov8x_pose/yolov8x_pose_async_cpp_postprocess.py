...
"""Yolov8x pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolov8x_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8x_poseFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolov8x pose Async Inference (C++ Postprocess)")


def main():
    args = parse_args()
    factory = Yolov8x_poseFactory()
