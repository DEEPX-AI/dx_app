...
"""Yolov8l pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolov8l_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8l_poseFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolov8l pose Async Inference (C++ Postprocess)")


def main():
    args = parse_args()
    factory = Yolov8l_poseFactory()
