...
"""Yolov8l pose Synchronous Inference Example (C++ Postprocess)

Usage:
    python yolov8l_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolov8l pose Sync Inference (C++ Postprocess)")
