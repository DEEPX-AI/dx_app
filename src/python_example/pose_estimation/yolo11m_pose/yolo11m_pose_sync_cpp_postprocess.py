...
"""Yolo11m pose Synchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11m_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11m pose Sync Inference (C++ Postprocess)")
