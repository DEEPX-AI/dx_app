...
"""Yolo11m pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11m_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11m pose Async Inference (C++ Postprocess)")
