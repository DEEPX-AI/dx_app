...
"""Yolov8n pose Synchronous Inference Example (C++ Postprocess)

Usage:
    python yolov8n_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolov8n pose Sync Inference (C++ Postprocess)")
