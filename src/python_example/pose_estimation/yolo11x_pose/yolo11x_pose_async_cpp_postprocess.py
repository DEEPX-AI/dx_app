...
"""Yolo11x pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11x_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo11x_poseFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolo11x pose Async Inference (C++ Postprocess)")


def main():
    args = parse_args()
    factory = Yolo11x_poseFactory()
