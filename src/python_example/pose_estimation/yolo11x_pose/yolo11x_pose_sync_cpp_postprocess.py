...
"""Yolo11x pose Synchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11x_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Yolo11x pose Sync Inference (C++ Postprocess)")
