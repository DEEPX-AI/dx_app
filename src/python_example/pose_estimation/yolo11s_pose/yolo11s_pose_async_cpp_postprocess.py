...
"""Yolo11s pose Asynchronous Inference Example (C++ Postprocess)

Usage:
    python yolo11s_pose_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo11s_poseFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Yolo11s pose Async Inference (C++ Postprocess)")


def main():
    args = parse_args()
    factory = Yolo11s_poseFactory()
