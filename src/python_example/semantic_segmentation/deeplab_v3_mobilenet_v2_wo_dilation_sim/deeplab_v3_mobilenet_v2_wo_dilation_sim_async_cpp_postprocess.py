...
"""
Deeplab v3 mobilenet v2 wo dilation sim Asynchronous Inference Example

Usage:
    python deeplab_v3_mobilenet_v2_wo_dilation_sim_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deeplab v3 mobilenet v2 wo dilation sim Async Inference")
