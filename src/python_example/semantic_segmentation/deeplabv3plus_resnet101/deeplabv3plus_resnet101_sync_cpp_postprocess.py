...
"""
Deeplabv3plus resnet101 Synchronous Inference Example
...
Usage:
    python deeplabv3plus_resnet101_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deeplabv3plus_resnet101Factory
...
def parse_args():
    return parse_common_args("Deeplabv3plus resnet101 Synchronous Inference")


def main():
    args = parse_args()
    factory = Deeplabv3plus_resnet101Factory()
