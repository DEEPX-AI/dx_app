...
"""
Deeplabv3plus resnet50 Async Inference Example
...
Usage:
    python deeplabv3plus_resnet50_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deeplabv3plus resnet50 Async Inference")
