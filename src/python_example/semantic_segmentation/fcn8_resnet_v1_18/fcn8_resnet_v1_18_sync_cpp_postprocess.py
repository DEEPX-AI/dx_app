...
"""
Fcn8 resnet v1 18 Synchronous Inference Example

Usage:
    python fcn8_resnet_v1_18_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Fcn8 resnet v1 18 Sync Inference")
