...
"""
Fcn8 resnet v1 18 Asynchronous Inference Example

Usage:
    python fcn8_resnet_v1_18_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Fcn8_resnet_v1_18Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Fcn8 resnet v1 18 Async Inference")


def main():
    args = parse_args()
    factory = Fcn8_resnet_v1_18Factory()
