...
"""
Deeplabv3 resnet101 Synchronous Inference Example
...
Usage:
    python deeplabv3_resnet101_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deeplabv3_resnet101Factory
...
def parse_args():
    return parse_common_args("Deeplabv3 resnet101 Synchronous Inference")


def main():
    args = parse_args()
    factory = Deeplabv3_resnet101Factory()
