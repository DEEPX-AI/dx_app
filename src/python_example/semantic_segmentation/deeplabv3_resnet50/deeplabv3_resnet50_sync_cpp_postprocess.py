...
"""
Deeplabv3 resnet50 Synchronous Inference Example
...
Usage:
    python deeplabv3_resnet50_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deeplabv3 resnet50 Synchronous Inference")
