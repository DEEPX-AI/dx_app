...
"""
DeepLabV3+ DRN 512x512 Synchronous Inference Example (C++ Postprocess)

C++ SemanticSegPostProcess passes through the NPU pre-argmaxed class map;
convert_cpp_semantic_seg resizes to the original image.

Usage:
    python deeplabv3plus_drn_512x512_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("DeepLabV3+ DRN 512x512 Synchronous Inference")
