...
"""
Fcn8 resnet50 Async Inference Example
...
Usage:
    python fcn8_resnet50_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Fcn8 resnet50 Async Inference")
