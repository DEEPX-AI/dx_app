...
"""
Fcn8 resnet50 Synchronous Inference Example
...
Usage:
    python fcn8_resnet50_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Fcn8_resnet50Factory
...
def parse_args():
    return parse_common_args("Fcn8 resnet50 Synchronous Inference")


def main():
    args = parse_args()
    factory = Fcn8_resnet50Factory()
