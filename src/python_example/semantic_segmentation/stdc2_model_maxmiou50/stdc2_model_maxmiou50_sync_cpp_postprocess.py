...
"""
Stdc2 model maxmiou50 Synchronous Inference Example

Usage:
    python stdc2_model_maxmiou50_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Stdc2 model maxmiou50 Sync Inference")
