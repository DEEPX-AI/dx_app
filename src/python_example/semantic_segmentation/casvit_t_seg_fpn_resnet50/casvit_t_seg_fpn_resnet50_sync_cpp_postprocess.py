...
"""
Casvit t seg fpn resnet50 Synchronous Inference Example
...
Usage:
    python casvit_t_seg_fpn_resnet50_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Casvit_t_seg_fpn_resnet50Factory
...
def parse_args():
    return parse_common_args("Casvit t seg fpn resnet50 Synchronous Inference")


def main():
    args = parse_args()
    factory = Casvit_t_seg_fpn_resnet50Factory()
