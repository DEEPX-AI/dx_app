...
"""
Casvit t seg fpn resnet50 Async Inference Example
...
Usage:
    python casvit_t_seg_fpn_resnet50_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Casvit t seg fpn resnet50 Async Inference")
