...
"""YOLO26-Depth-N Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_n_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26-Depth-N Sync Inference (C++ postprocess)")
