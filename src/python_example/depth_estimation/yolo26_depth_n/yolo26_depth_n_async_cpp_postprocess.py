...
"""YOLO26-Depth-N Asynchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_n_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Yolo26DepthNFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("YOLO26-Depth-N Async Inference (C++ postprocess)")


def main():
    args = parse_args()
    factory = Yolo26DepthNFactory()
