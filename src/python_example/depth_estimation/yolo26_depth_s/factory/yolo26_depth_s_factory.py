"""
Yolo26DepthS Factory — YOLO26-Depth-S monocular depth estimation (DX-M1 NPU).

Source model: `yolo26-depth-s_768x768.dxnn` — a single dense depth
...
class Yolo26DepthSFactory(IDepthEstimationFactory):
    """Factory for YOLO26-Depth-S components."""
