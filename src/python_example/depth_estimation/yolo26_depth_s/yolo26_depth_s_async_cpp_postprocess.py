...
"""YOLO26-Depth-S Asynchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_s_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Yolo26DepthSFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("YOLO26-Depth-S Async Inference (C++ postprocess)")


def main():
    args = parse_args()
    factory = Yolo26DepthSFactory()
