...
"""YOLO26-Depth-S Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_s_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26-Depth-S Sync Inference (C++ postprocess)")
