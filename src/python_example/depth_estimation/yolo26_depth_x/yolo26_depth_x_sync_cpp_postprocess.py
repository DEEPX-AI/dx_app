...
"""YOLO26-Depth-X Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_x_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26-Depth-X Sync Inference (C++ postprocess)")
