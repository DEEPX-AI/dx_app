"""
Yolo26DepthX Factory — YOLO26-Depth-X monocular depth estimation (DX-M1 NPU).

Source model: `yolo26-depth-x_768x768.dxnn` — a single dense depth
...
class Yolo26DepthXFactory(IDepthEstimationFactory):
    """Factory for YOLO26-Depth-X components."""
