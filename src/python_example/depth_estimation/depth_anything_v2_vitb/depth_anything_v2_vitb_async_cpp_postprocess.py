...
"""Depth anything v2 vitb Asynchronous Inference Example

Usage:
    python depth_anything_v2_vitb_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Depth_anything_v2_vitbFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Depth anything v2 vitb Async Inference")


def main():
    args = parse_args()
    factory = Depth_anything_v2_vitbFactory()
