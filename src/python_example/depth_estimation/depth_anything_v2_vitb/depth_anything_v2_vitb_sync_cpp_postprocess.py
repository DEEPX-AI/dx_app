...
"""Depth anything v2 vitb Synchronous Inference Example

Usage:
    python depth_anything_v2_vitb_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Depth anything v2 vitb Sync Inference")
