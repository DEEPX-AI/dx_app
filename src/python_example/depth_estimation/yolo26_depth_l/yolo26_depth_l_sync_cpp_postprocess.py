...
"""YOLO26-Depth-L Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_l_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26-Depth-L Sync Inference (C++ postprocess)")
