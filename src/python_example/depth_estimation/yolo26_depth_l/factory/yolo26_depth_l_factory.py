"""
Yolo26DepthL Factory — YOLO26-Depth-L monocular depth estimation (DX-M1 NPU).

Source model: `yolo26-depth-l_768x768.dxnn` — a single dense depth
...
class Yolo26DepthLFactory(IDepthEstimationFactory):
    """Factory for YOLO26-Depth-L components."""
