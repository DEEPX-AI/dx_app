...
"""YOLO26n-Depth Asynchronous Inference Example (C++ postprocess)

Usage:
    python yolo26n_depth_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo26nDepthFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("YOLO26n-Depth Async Inference (C++ postprocess)")


def main():
    args = parse_args()
    factory = Yolo26nDepthFactory()
