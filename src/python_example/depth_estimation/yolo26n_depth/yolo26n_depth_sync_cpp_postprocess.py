...
"""YOLO26n-Depth Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26n_depth_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26n-Depth Sync Inference (C++ postprocess)")
