...
"""Depth anything v2 vitl Asynchronous Inference Example

Usage:
    python depth_anything_v2_vitl_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Depth_anything_v2_vitlFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Depth anything v2 vitl Async Inference")


def main():
    args = parse_args()
    factory = Depth_anything_v2_vitlFactory()
