...
"""YOLO26-Depth-M Synchronous Inference Example (C++ postprocess)

Usage:
    python yolo26_depth_m_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLO26-Depth-M Sync Inference (C++ postprocess)")
