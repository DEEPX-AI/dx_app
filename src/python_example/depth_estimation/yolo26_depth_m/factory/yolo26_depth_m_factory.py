"""
Yolo26DepthM Factory — YOLO26-Depth-M monocular depth estimation (DX-M1 NPU).

Source model: `yolo26-depth-m_768x768.dxnn` — a single dense depth
...
class Yolo26DepthMFactory(IDepthEstimationFactory):
    """Factory for YOLO26-Depth-M components."""
