...
"""DOPE Hope-Ketchup Synchronous Inference Example (C++ Postprocess)

Usage:
    python dope_hope_ketchup_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("DOPE Hope-Ketchup Sync Inference")
