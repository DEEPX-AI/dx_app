...
"""
ESPCN x2 Synchronous Inference Example

Usage:
    python espcn_x2_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("ESPCN x2 Synchronous Inference")
