...
"""
SFA3D Synchronous Inference with C++ Postprocessing

Usage:
    python sfa3d_608x608_sync_cpp_postprocess.py --model model.dxnn --image pointcloud.bin
"""
...
def parse_args():
    return parse_common_args(
        "SFA3D 608x608 Sync Inference (C++ postprocess)",
