...
"""YOLOv5n Face Synchronous Inference Example

Usage:
    python yolov5n_face_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLOv5n Face Sync Inference")
