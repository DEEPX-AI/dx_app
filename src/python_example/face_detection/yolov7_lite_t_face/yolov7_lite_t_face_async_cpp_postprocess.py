...
"""YOLOv7 Lite T Face Asynchronous Inference Example

Usage:
    python yolov7_lite_t_face_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7_lite_t_faceFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("YOLOv7 Lite T Face Async Inference")


def main():
    args = parse_args()
    factory = Yolov7_lite_t_faceFactory()
