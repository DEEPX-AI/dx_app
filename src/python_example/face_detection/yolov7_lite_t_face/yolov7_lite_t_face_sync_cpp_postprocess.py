...
"""YOLOv7 Lite T Face Synchronous Inference Example

Usage:
    python yolov7_lite_t_face_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLOv7 Lite T Face Sync Inference")
