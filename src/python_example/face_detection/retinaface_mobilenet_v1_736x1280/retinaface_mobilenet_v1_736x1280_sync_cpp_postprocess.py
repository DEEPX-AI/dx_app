...
"""
Retinaface mobilenet v1 736x1280 Synchronous Inference Example

Usage:
    python retinaface_mobilenet_v1_736x1280_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Retinaface mobilenet v1 736x1280 Sync Inference")
