...
"""Repghost 2 0x Asynchronous Inference Example

Usage:
    python repghost_2_0x_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Repghost_2_0xFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Repghost 2 0x Async Inference")


def main():
    args = parse_args()
    factory = Repghost_2_0xFactory()
