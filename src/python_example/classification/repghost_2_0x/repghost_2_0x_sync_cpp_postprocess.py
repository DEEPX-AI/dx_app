...
"""Repghost 2 0x Synchronous Inference Example

Usage:
    python repghost_2_0x_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Repghost 2 0x Sync Inference")
