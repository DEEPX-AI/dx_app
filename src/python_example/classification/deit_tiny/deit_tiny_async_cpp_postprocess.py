...
"""Deit tiny Asynchronous Inference Example

Usage:
    python deit_tiny_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_tinyFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit tiny Async Inference")


def main():
    args = parse_args()
    factory = Deit_tinyFactory()
