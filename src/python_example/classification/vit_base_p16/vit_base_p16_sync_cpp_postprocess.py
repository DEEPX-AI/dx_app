...
"""Vit base p16 Synchronous Inference Example

Usage:
    python vit_base_p16_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Vit base p16 Sync Inference")
