...
"""Repvgg a2 Asynchronous Inference Example

Usage:
    python repvgg_a2_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Repvgg_a2Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Repvgg a2 Async Inference")


def main():
    args = parse_args()
    factory = Repvgg_a2Factory()
