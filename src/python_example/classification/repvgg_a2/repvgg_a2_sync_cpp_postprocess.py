...
"""Repvgg a2 Synchronous Inference Example

Usage:
    python repvgg_a2_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Repvgg a2 Sync Inference")
