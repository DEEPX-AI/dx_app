...
"""Deit base distilled 1 Synchronous Inference Example

Usage:
    python deit_base_distilled_1_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit base distilled 1 Sync Inference")
