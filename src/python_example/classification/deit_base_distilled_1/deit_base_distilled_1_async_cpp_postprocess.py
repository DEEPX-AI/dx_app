...
"""Deit base distilled 1 Asynchronous Inference Example

Usage:
    python deit_base_distilled_1_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_base_distilled_1Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit base distilled 1 Async Inference")


def main():
    args = parse_args()
    factory = Deit_base_distilled_1Factory()
