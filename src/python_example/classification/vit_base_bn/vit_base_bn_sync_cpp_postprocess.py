...
"""Vit base bn Synchronous Inference Example

Usage:
    python vit_base_bn_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Vit base bn Sync Inference")
