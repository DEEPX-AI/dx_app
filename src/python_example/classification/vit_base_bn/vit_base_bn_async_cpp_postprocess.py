...
"""Vit base bn Asynchronous Inference Example

Usage:
    python vit_base_bn_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Vit_base_bnFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Vit base bn Async Inference")


def main():
    args = parse_args()
    factory = Vit_base_bnFactory()
