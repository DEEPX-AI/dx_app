...
"""Fastvit sa24 Asynchronous Inference Example

Usage:
    python fastvit_sa24_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Fastvit_sa24Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Fastvit sa24 Async Inference")


def main():
    args = parse_args()
    factory = Fastvit_sa24Factory()
