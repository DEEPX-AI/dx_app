...
"""Fastvit sa24 Synchronous Inference Example

Usage:
    python fastvit_sa24_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Fastvit sa24 Sync Inference")
