...
Usage:
    python regnetx1_6gf_v2_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Regnetx1_6gf_v2Factory
...
def main():
    args = parse_args()
    factory = Regnetx1_6gf_v2Factory()
