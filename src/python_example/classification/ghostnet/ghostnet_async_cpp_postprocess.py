...
"""Ghostnet Asynchronous Inference Example

Usage:
    python ghostnet_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import GhostnetFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Ghostnet Async Inference")


def main():
    args = parse_args()
    factory = GhostnetFactory()
