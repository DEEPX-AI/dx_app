...
"""Deit base distilled 2 Asynchronous Inference Example

Usage:
    python deit_base_distilled_2_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_base_distilled_2Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit base distilled 2 Async Inference")


def main():
    args = parse_args()
    factory = Deit_base_distilled_2Factory()
