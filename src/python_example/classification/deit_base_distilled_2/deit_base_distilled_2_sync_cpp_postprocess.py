...
"""Deit base distilled 2 Synchronous Inference Example

Usage:
    python deit_base_distilled_2_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit base distilled 2 Sync Inference")
