...
"""
Deit base384 distilled Asynchronous Inference Example (C++ postprocess)

Usage:
    python deit_base384_distilled_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_base384_distilledFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit base384 distilled Async Inference")


def main():
    args = parse_args()
    factory = Deit_base384_distilledFactory()
