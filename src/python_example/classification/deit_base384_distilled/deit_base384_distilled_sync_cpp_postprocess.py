...
"""
Deit base384 distilled Synchronous Inference Example (C++ postprocess)

Usage:
    python deit_base384_distilled_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit base384 distilled Sync Inference")
