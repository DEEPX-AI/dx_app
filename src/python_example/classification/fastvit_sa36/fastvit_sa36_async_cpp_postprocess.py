...
"""Fastvit sa36 Asynchronous Inference Example

Usage:
    python fastvit_sa36_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Fastvit_sa36Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Fastvit sa36 Async Inference")


def main():
    args = parse_args()
    factory = Fastvit_sa36Factory()
