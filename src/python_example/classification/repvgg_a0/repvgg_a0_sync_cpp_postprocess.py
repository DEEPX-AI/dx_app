...
"""Repvgg a0 Synchronous Inference Example

Usage:
    python repvgg_a0_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Repvgg a0 Sync Inference")
