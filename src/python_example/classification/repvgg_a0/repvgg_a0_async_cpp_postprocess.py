...
"""Repvgg a0 Asynchronous Inference Example

Usage:
    python repvgg_a0_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Repvgg_a0Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Repvgg a0 Async Inference")


def main():
    args = parse_args()
    factory = Repvgg_a0Factory()
