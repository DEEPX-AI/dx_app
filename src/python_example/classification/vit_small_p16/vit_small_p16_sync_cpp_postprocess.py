...
"""Vit small p16 Synchronous Inference Example

Usage:
    python vit_small_p16_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Vit small p16 Sync Inference")
