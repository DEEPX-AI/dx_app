...
"""Vit small p16 Asynchronous Inference Example

Usage:
    python vit_small_p16_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Vit_small_p16Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Vit small p16 Async Inference")


def main():
    args = parse_args()
    factory = Vit_small_p16Factory()
