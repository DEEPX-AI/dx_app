...
"""Efficientnetv2m Asynchronous Inference Example

Usage:
    python efficientnetv2m_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Efficientnetv2mFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Efficientnetv2m Async Inference")


def main():
    args = parse_args()
    factory = Efficientnetv2mFactory()
