...
"""Efficientnetv2m Synchronous Inference Example

Usage:
    python efficientnetv2m_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Efficientnetv2m Sync Inference")
