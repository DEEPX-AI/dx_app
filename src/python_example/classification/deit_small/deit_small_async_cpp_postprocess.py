...
"""Deit small Asynchronous Inference Example

Usage:
    python deit_small_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_smallFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit small Async Inference")


def main():
    args = parse_args()
    factory = Deit_smallFactory()
