...
"""Deit small Synchronous Inference Example

Usage:
    python deit_small_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit small Sync Inference")
