...
"""Efficientnetb7 Asynchronous Inference Example

Usage:
    python efficientnetb7_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Efficientnetb7Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Efficientnetb7 Async Inference")


def main():
    args = parse_args()
    factory = Efficientnetb7Factory()
