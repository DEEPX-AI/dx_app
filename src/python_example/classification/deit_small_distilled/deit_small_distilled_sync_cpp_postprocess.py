...
"""Deit small distilled Synchronous Inference Example

Usage:
    python deit_small_distilled_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit small distilled Sync Inference")
