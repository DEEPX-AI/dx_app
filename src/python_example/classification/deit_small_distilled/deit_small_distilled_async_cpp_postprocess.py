...
"""Deit small distilled Asynchronous Inference Example

Usage:
    python deit_small_distilled_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_small_distilledFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit small distilled Async Inference")


def main():
    args = parse_args()
    factory = Deit_small_distilledFactory()
