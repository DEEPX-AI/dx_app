...
"""Deit tiny distilled Asynchronous Inference Example

Usage:
    python deit_tiny_distilled_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Deit_tiny_distilledFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Deit tiny distilled Async Inference")


def main():
    args = parse_args()
    factory = Deit_tiny_distilledFactory()
