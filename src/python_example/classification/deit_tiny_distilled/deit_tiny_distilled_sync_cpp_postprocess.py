...
"""Deit tiny distilled Synchronous Inference Example

Usage:
    python deit_tiny_distilled_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Deit tiny distilled Sync Inference")
