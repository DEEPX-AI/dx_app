...
"""Repvgg a1 Asynchronous Inference Example

Usage:
    python repvgg_a1_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Repvgg_a1Factory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Repvgg a1 Async Inference")


def main():
    args = parse_args()
    factory = Repvgg_a1Factory()
