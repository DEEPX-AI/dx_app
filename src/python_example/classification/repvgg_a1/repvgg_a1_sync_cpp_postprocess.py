...
"""Repvgg a1 Synchronous Inference Example

Usage:
    python repvgg_a1_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Repvgg a1 Sync Inference")
