...
Usage:
    python resnext50_32x4d_imgclsmob_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Resnext50_32x4d_imgclsmobFactory
...
def main():
    args = parse_args()
    factory = Resnext50_32x4d_imgclsmobFactory()
