...
"""
Beit large patch16 Synchronous Inference Example

Usage:
    python beit_large_patch16_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Beit large patch16 Sync Inference")
