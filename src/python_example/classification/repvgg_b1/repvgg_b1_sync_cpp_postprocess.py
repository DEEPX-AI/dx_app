...
"""Repvgg b1 Synchronous Inference Example

Usage:
    python repvgg_b1_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Repvgg b1 Sync Inference")
