...
"""
Vit b 32 256 datacomp s34b b86k Synchronous Inference Example

Usage:
    python vit_b_32_256_datacomp_s34b_b86k_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Vit b 32 256 datacomp s34b b86k Sync Inference", include_stream_inputs=False)
