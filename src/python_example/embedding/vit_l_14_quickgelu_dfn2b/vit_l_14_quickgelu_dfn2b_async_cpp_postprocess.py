...
"""
Vit l 14 quickgelu dfn2b Asynchronous Inference Example

Usage:
    python vit_l_14_quickgelu_dfn2b_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("Vit l 14 quickgelu dfn2b Async Inference", include_stream_inputs=False)
