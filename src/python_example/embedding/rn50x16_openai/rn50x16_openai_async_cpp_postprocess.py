...
"""
Rn50x16 openai Asynchronous Inference Example

Usage:
    python rn50x16_openai_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Rn50x16_openaiFactory
from common.runner import AsyncRunner, parse_common_args


def parse_args():
    return parse_common_args("Rn50x16 openai Async Inference", include_stream_inputs=False)


def main():
    args = parse_args()
    factory = Rn50x16_openaiFactory()
