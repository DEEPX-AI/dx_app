...
Usage:
    python damoyolo_tinynasl20_m_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Damoyolo_tinynasl20_mFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("DAMO-YOLO-TINYNASL20_M Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Damoyolo_tinynasl20_mFactory()
