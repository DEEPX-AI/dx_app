...
Usage:
    python damoyolo_tinynasl20_m_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("DAMO-YOLO-TINYNASL20_M Sync Inference (C++ Postprocess)")
def main():
    args = parse_args()
