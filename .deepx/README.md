...
│   ├── dx-agent-app-build-python.md         # Build Python inference app
│   ├── dx-agent-app-build-cpp.md            # Build C++ inference app
│   ├── dx-agent-app-build-async.md          # Build async high-performance app
│   ├── dx-agent-app-model-management.md         # Model download and registry
│   ├── dx-agent-app-validate.md                 # 5-level validation pyramid
