...
├── templates/                         # Instruction templates (processed by dx-agentic-gen)
...
> See [`.deepx/tools/README.md`](../../../.deepx/tools/README.md) in the suite root.
...
### Platform generation (`dx-agentic-gen`)
...
See [`.deepx/tools/README.md`](../../../.deepx/tools/README.md) and
[`.deepx/tools/scripts/README.md`](../../../.deepx/tools/scripts/README.md)
in the suite root for the full guide.
...
against the suite-level fragment library by `dx-agentic-gen`.
...
All platform files are generated by `dx-agentic-gen` from `.deepx/` canonical source:
...
2. Run `dx-agentic-gen check` (drift report)
3. Run `dx-agentic-gen generate`
