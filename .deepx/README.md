...
│   ├── model_zoo.md                   # 347 models across 22 tasks
...
| `model-registry.md` | model_registry.json schema, query patterns, 347 models, naming conventions |
...
- **dx_app v3.2.0**: 22 AI tasks, 347 models, 4 Python variants, C++ examples
