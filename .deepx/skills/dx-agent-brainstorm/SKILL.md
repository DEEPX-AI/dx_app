...
- Before invoking `/dx-agent-app-build-python`, `/dx-agent-app-build-cpp`, or `/dx-agent-app-build-async`
...
**Output dir**: dx-agent-dev/<YYYYMMDD-HHMMSS>_<model>_<task>/
...
| App type | Invoke |
|----------|--------|
| Python (any variant) | `/dx-agent-app-build-python` |
| C++ | `/dx-agent-app-build-cpp` |
| Async-focused | `/dx-agent-app-build-async` |

## Defaults (for "just build it")

- App type: Python, Variants: All 4, Output: `dx-agent-dev/`
