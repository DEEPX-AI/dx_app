...
DEMO_CPP_BASE=(
    yolov7 yolov11n scrfd500m yolov8s_pose yolo26n_obb handlandmarklite_1
    yolov8n_seg deeplabv3plusmobilenet
    resnet50 fastdepth_1 dncnn_50 espcn_x4 zero_dce arcface_mobilefacenet
    yolov7_ppu
)
...
DEMO_MODEL=(
    YoloV7.dxnn YOLOV11N.dxnn SCRFD500M.dxnn yolov8s_pose.dxnn yolo26n-obb.dxnn HandLandmarkLite_1.dxnn
    yolov8n_seg.dxnn DeepLabV3PlusMobileNetV2.dxnn
    ResNet50.dxnn FastDepth_1.dxnn DnCNN_50.dxnn ESPCN_X4.dxnn zero_dce.dxnn arcface_mobilefacenet.dxnn
    YoloV7_PPU.dxnn
)
...
DEMO_PY_ASYNC=(
    ...
    full full
    no_py_async full full full full no_py_async
    full
)
...
Interactive 3-stage menu:
    Stage 1: Select AI task (15 options)
