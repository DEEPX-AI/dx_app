...
| face_alignment | `sample_face.jpg`, `sample_face_a1.jpg` | `sample/img/` |
| pose_estimation | `sample_people.jpg`, `sample_crowd.jpg` | `sample/img/` |
| keypoint_detection | `sample_street.jpg` | `sample/img/` |
...
| panoptic_driving_perception | `sample_parking.jpg`, `sample_street.jpg` | `sample/img/` |
...
| depth_estimation | `sample_street.jpg`, `sample_horse.jpg` | `sample/img/` |
| ppu | `sample_street.jpg` | `sample/img/` |
| embedding *(image only)* | `sample_face.jpg`, `face_pair/` | `sample/img/` |
| reid *(image only)* | `person_pair/` | `sample/img/` |
| attribute_recognition *(image only)* | `sample_person_a1.jpg` | `sample/img/` |
| hand_detection | `sample_hand.jpg` (img) / `hand.mp4` (video) | `sample/img/`, `assets/videos/` |
| object_pose_estimation *(image only)* | `000000.png` | `sample/dope/` |
| 3d_object_detection *(point cloud only)* | `velodyne/000049.bin` (LiDAR .bin) | `sample/kitti/` |
| Video (video-supported tasks only) | `dogs.mp4`, `blackbox-city-road.mp4`, `boat.mp4` | `assets/videos/` |
