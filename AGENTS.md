...
dx_app provides 133 compiled `.dxnn` models across 22 AI tasks with Python (4 variants) and C++ examples.
...
16. **Skeleton-first development** — Read `.deepx/skills/dx-agent-app-build-python.md` skeleton
