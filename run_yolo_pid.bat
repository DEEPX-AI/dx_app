...
set "APP_MODEL0_PATH=%~dp0\..\models\YOLOV5S_3.dxnn"
set "APP_MODEL1_PATH=%~dp0\..\models\DeepLabV3PlusMobileNetV2_2.dxnn"
set "APP_VIDEO_PATH=%~dp0\..\videos\blackbox-city-road.mp4"
