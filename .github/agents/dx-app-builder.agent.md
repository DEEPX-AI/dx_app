...
- label: Build Python App
  ...
  prompt: Build a Python inference application using SyncRunner or AsyncRunner.
  send: false
- label: Build C++ App
  agent: dx-cpp-builder
  prompt: Build a C++ inference application using InferenceEngine directly.
  send: false
...
- label: Manage Models
  ...
  prompt: Download, register, or query .dxnn models from model_registry.json.
  send: false
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/agents/dx-app-builder.md -->
...
3. Read `.github/skills/dx-agent-app-build-python.md` (if Python app)
