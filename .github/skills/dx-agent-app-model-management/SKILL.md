---
name: dx-agent-app-model-management
description: Model download, HEF resolution, and config management
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agent-app-model-management/SKILL.md -->
...
Use `dx-agent-app-build-python` or `dx-agent-app-build-cpp` skill to generate the
application code.
