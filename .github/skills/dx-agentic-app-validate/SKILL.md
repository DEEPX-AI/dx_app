---
name: dx-agentic-app-validate
description: Validation workflow for dx_app
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-app-validate/SKILL.md -->
...
factory_path = sys.argv[2]  # e.g., factory/yolo26n_factory.py
    ...
    # For the authoritative list of C++ bindings, see:
    #   src/bindings/python/dx_postprocess/postprocess_pybinding.cpp
    REGISTRY_TO_POSTPROCESSOR = {
        ...
        "efficientdet": "EfficientDetPostprocessor",
        # Classification
        "efficientnet": "ClassificationPostprocessor",
        # Attribute recognition (uses classification postprocessor)
        "attribute_recognition": "ClassificationPostprocessor",
        # Pose
        ...
        "reid": "ArcFacePostprocessor",               # ReID uses embedding postprocessor
        # OBB
        "obb": "OBBPostprocessor",
        # PPU
        "yolov5_ppu": "YOLOv5PPUPostprocessor",
        "yolov7_ppu": "YOLOv7PPUPostprocessor",
        "yolov8_ppu": "YOLOv8PPUPostprocessor",
        "yolox_ppu": "YOLOXPPUPostprocessor",
        "yolov3tiny_ppu": "YOLOv3TinyPPUPostprocessor",
        # Hand
