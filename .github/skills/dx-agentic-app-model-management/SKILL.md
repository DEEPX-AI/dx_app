---
name: dx-agentic-app-model-management
description: Model download, HEF resolution, and config management
---

<!-- AUTO-GENERATED from .deepx/ — DO NOT EDIT DIRECTLY -->
<!-- Source: .deepx/skills/dx-agentic-app-model-management/SKILL.md -->
...
Use `dx-agentic-app-build-python` or `dx-agentic-app-build-cpp` skill to generate the
application code.
