...
DEMOS = [
    ...
    ("Depth Estimation         (SCDepthV3)", "Depth Estimation", "scdepthv3", "depth_estimation/scdepthv3", "scdepthv3", "scdepthv3_256x320.dxnn", "assets/videos/blackbox-city-road.mp4", "sample/img/sample_parking.jpg", True, False),
    ...
    ("Super Resolution         (ESPCN-X4)", "Image Restoration", "espcn_x4", "super_resolution/espcn_x4", "espcn_x4", "espcn-x4_17x17.dxnn", "assets/videos/dance-group.mov", "sample/img/sample_superresolution.png", True, False),
