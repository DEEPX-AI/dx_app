...
print_colored() {
    ...
    case "$level" in
        # TAG
        "ERROR") printf "${COLOR_BG_RED}[DXAPP] [ERROR]${COLOR_RESET}${COLOR_BRIGHT_RED} %s ${COLOR_RESET}\n" "$message" >&2 ;;
        ...
        "INFO") printf "${COLOR_BG_BLUE}[DXAPP] [INFO]${COLOR_RESET}${COLOR_BRIGHT_BLUE} %s ${COLOR_RESET}\n" "$message" >&2 ;;
        "WARNING") printf "${COLOR_BLACK_ON_YELLOW}[DXAPP] [WARN]${COLOR_RESET}${COLOR_BRIGHT_YELLOW} %s ${COLOR_RESET}\n" "$message" >&2 ;;
